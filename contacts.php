...
?>
    <!DOCTYPE html>
<html data-wf-page="672b6e839ec11c45e1f817f5" data-wf-site="6720c60d7d5faf3e7ea1ac86">
...
<input type="submit" class="search-button w-button" value="Search"><a href="#" class="clear-search">очистить</a></form>
						...
						<div class="slider_home-slider_slide-in">
							<div class="mom-abs"><img src="<?php echo get_template_directory_uri() ?>/images/672b6e9793b7739cd2b1f4a7_22201.avif" loading="eager" alt class="img-cover"></div>
							<div class="slider-bottom-content inner-pages">
								<div class="horiz">
									<div class="p-12-12 uper">салон love forever</div>
									<div class="indirm-line_romb"></div>
									<div class="p-12-12 uper">контакты</div>
								</div>
								<h1 class="p-86-96">контакты</h1>
							</div>
						</div>
					</div>
				</section>
						...
						<div class="flex-about n-rev">
							<div class="div-block-3 cont-grid">
								<div id="w-node-c005dd64-42af-02aa-2c87-fd11761efe0b-e1f817f5" class="div-block-4 cont-item">
									...
									<div class="vert cont-vert"><a href="#" class="p-36-36 cont-p">г. Санкт-Петербург, <br>Вознесенский проспект 18-36 </a>
										<div class="horiz">
											<div class="metro-dot">м</div>
											<div class="p-12-12 uper m-12-12">Садовая</div>
											<div class="_2px_cube black"></div>
											<div class="p-12-12 uper m-12-12">СадАДМИРАЛТЕЙСКАЯовая</div>
										</div>
									</div>
								</div>
							</div>
							<div class="div-block-3 cont-grid">
								<div id="w-node-c9006335-3f7e-a7da-f9d9-ef62baf91847-e1f817f5" class="div-block-4 cont-item">
									<div class="p-12-12 uper m-12-12">номер и почта</div>
									<div class="vert"><a href="#" class="a-32-40">8 (812) 425-69-36 </a><a href="#" class="a-32-40">spb@salon-love.ru</a></div>
								</div>
								<div id="w-node-_12072c89-a372-3919-6922-5b80aacd4cc3-e1f817f5" class="div-block-4 cont-item">
									...
									<div class="a-32-40">Пн-Вс с 10:00 до 22:00 и до последнего клиента</div>
								</div>
								...
								<div id="w-node-_98436ef0-1da5-fdcb-8dc9-c5f8768d1098-e1f817f5" class="div-block-4 cont-item">
									...
									<div class="p-16-20 n-top m-16-20">ИП Жуль П.Р.  <br>ИНН 245727918185   <br>ОГРНИП 313774618300382</div>
								</div>
							</div>
						</div>
					</div>
