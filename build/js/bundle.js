...
class Dialog {
  ...
  onClick(event) {
    ...
    if (event.target.matches(this.selectors.closeButton) || !event.target.closest(this.selectors.dialogContent)) {
      this.close();
      return;
    }
  }
...
class SearchForm {
  ...
  constructor(element) {
    ...
    this.onDebouncedInput = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.debounce)(this.onInput, 500);
    this.bindEvents();
  }
  async queryProducts() {
    if (this.root.classList.contains(this.stateSelectors.isLoading)) {
  ...
  onInput = async event => {
    const {
      data,
      error
    } = await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.promiseWrapper)(this.queryProducts());
    console.log({
      data,
      error,
...
/* harmony import */ var _Dialog__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Dialog */ "./src/Dialog.js");
/* harmony import */ var _FavoritesButtonWithCounter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./FavoritesButtonWithCounter */ "./src/FavoritesButtonWithCounter.js");
/* harmony import */ var _FileInput__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./FileInput */ "./src/FileInput.js");
/* harmony import */ var _FittingForm__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./FittingForm */ "./src/FittingForm.js");
/* harmony import */ var _FormValidator__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./FormValidator */ "./src/FormValidator.js");
/* harmony import */ var _InputMask__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./InputMask */ "./src/InputMask.js");
/* harmony import */ var _MaskedPhoneButton__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./MaskedPhoneButton */ "./src/MaskedPhoneButton.js");
/* harmony import */ var _ProductFilterForm__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./ProductFilterForm */ "./src/ProductFilterForm.js");
/* harmony import */ var _RangeSlider__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./RangeSlider */ "./src/RangeSlider.js");
/* harmony import */ var _ReviewForm__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./ReviewForm */ "./src/ReviewForm.js");
/* harmony import */ var _SearchForm__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./SearchForm */ "./src/SearchForm.js");
...
/* harmony import */ var _VideoPlayer__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./VideoPlayer */ "./src/VideoPlayer.js");
...
new _FormValidator__WEBPACK_IMPORTED_MODULE_10__["default"]();
new _MaskedPhoneButton__WEBPACK_IMPORTED_MODULE_12__["default"]();
document.addEventListener('DOMContentLoaded', function () {
  ...
  barba_js__WEBPACK_IMPORTED_MODULE_1___default().Dispatcher.on('initStateChange', currentStatus => {
    ...
    _SearchForm__WEBPACK_IMPORTED_MODULE_16__["default"].destroyAll();
    _FavoritesButtonWithCounter__WEBPACK_IMPORTED_MODULE_7__["default"].destroyAll();
    _CopyToClipboardButton__WEBPACK_IMPORTED_MODULE_4__["default"].destroyAll();
    _InputMask__WEBPACK_IMPORTED_MODULE_11__["default"].destroyAll();
    _Dialog__WEBPACK_IMPORTED_MODULE_6__["default"].destroyAll();
    _Accordion__WEBPACK_IMPORTED_MODULE_2__.AccordionCollection.destroyAll();
    _FittingForm__WEBPACK_IMPORTED_MODULE_9__.FittingFormCollection.destroyAll();
    _ProductFilterForm__WEBPACK_IMPORTED_MODULE_13__["default"].destroyAll();
    _RangeSlider__WEBPACK_IMPORTED_MODULE_14__["default"].destroyAll();
    _ReviewForm__WEBPACK_IMPORTED_MODULE_15__["default"].destroyAll();
    _FileInput__WEBPACK_IMPORTED_MODULE_8__["default"].destroyAll();
    _VideoPlayer__WEBPACK_IMPORTED_MODULE_18__["default"].destroyAll();
...
function initPage() {
  ...
  _SearchForm__WEBPACK_IMPORTED_MODULE_16__["default"].init();
  initHeroPageSliderPagination();
  _FavoritesButtonWithCounter__WEBPACK_IMPORTED_MODULE_7__["default"].init();
  _InputMask__WEBPACK_IMPORTED_MODULE_11__["default"].init();
  _Dialog__WEBPACK_IMPORTED_MODULE_6__["default"].init();
  ...
  _VideoPlayer__WEBPACK_IMPORTED_MODULE_18__["default"].init();
  _CustomSelect__WEBPACK_IMPORTED_MODULE_5__["default"].init();
}
function initCatalogPage() {
  console.log('init catalog page');
  _ProductFilterForm__WEBPACK_IMPORTED_MODULE_13__["default"].init();
  _RangeSlider__WEBPACK_IMPORTED_MODULE_14__["default"].init();
}
function initSingleDressPage() {
  console.log('init single dress page');
  _FittingForm__WEBPACK_IMPORTED_MODULE_9__.FittingFormCollection.init();
}
function initReviewsPage() {
  console.log('init reviews page');
  _ReviewForm__WEBPACK_IMPORTED_MODULE_15__["default"].init();
  _FileInput__WEBPACK_IMPORTED_MODULE_8__["default"].init();
}
