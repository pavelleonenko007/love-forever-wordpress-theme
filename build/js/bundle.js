...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AccordionCollection: () => (/* binding */ AccordionCollection)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ AddToFavoriteButtonCollection)
/* harmony export */ });
...
class AddToFavoriteButtonCollection {
  ...
  async onAddToFavoritesButtonClick(button) {
    ...
    try {
      ...
      barba_js__WEBPACK_IMPORTED_MODULE_0___default().BaseCache.reset();
      ...
      button.dispatchEvent(new CustomEvent('favoritesUpdated', {
        bubbles: true,
        detail: {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CardSliderCollection)
/* harmony export */ });
...
class CardSlider {
   ...
   */
  activateSlide(num) {
    this.root.querySelectorAll(this.selectors.slideItem).forEach((slideItem, index) => {
      slideItem.classList.toggle(this.stateSelectors.isActive, index === num);
    });
    this.root.querySelectorAll(this.selectors.navItem).forEach((navItem, index) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CopyToClipboardButtonCollection)
/* harmony export */ });
...
class CopyToClipboardButton extends _BaseComponent__WEBPACK_IMPORTED_MODULE_0__["default"] {
  selectors = {
    root: ROOT_SELECTOR,
   ...
   */
  constructor(element) {
    var _this$button$querySel;
    super();
    this.button = element;
    this.buttonTextElement = (_this$button$querySel = this.button.querySelector(this.selectors.buttonText)) !== null && _this$button$querySel !== void 0 ? _this$button$querySel : this.button;
  ...
  updateUI() {
    ...
    if (!this.state.hasError) {
      this.buttonTextElement.textContent = this.state.isCopied ? 'Скопировано' : this.buttonText;
    } else {
  ...
  onClick(event) {
    ...
    event.preventDefault();
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.copyTextToClipboard)(this.textToCopy).then(() => {
...
class CopyToClipboardButtonCollection {
  /**
...
/* harmony export */ });
/* harmony import */ var _MatchMedia__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MatchMedia */ "./src/MatchMedia.js");
...
class CustomDatepicker {
  ...
  constructor(element) {
    ...
    this.toggleControls();
    const datepickerConfig = this.customControl.dataset.jsDatepickerConfig ? JSON.parse(this.customControl.dataset.jsDatepickerConfig) : {};
    $(this.customControl).datepicker({
      ...
      onSelect: (dateString, instance) => {
        this.originalControl.dispatchEvent(new Event('change', {
          bubbles: true
        }));
      },
      ...datepickerConfig
  ...
  toggleControls(isMobile = _MatchMedia__WEBPACK_IMPORTED_MODULE_0__["default"].mobile.matches) {
  ...
  bindEvents() {
    _MatchMedia__WEBPACK_IMPORTED_MODULE_0__["default"].mobile.addEventListener('change', this.onMatchMediaChange);
  }
  destroy() {
    _MatchMedia__WEBPACK_IMPORTED_MODULE_0__["default"].mobile.removeEventListener('change', this.onMatchMediaChange);
...
class CustomDatepickerCollection {
  ...
  static init() {
    document.querySelectorAll(ROOT_SELECTOR).forEach(element => {
      ...
      CustomDatepickerCollection.customDatepickers.set(element, CustomDatepickerInstance);
    });
  }
  static destroyAll() {
...
/* harmony import */ var _MatchMedia__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MatchMedia */ "./src/MatchMedia.js");
...
class CustomSelect {
  ...
  constructor(element) {
    this.root = element;
    this.optionsAttr = element.dataset.jsCustomSelect ? JSON.parse(element.dataset.jsCustomSelect) : {};
    this.selectOptions = {
      hasBorder: true,
      type: 'select',
      ...this.optionsAttr
  ...
  init() {
    $(this.root).selectmenu({
      ...
      classes: {
        'ui-selectmenu-button': classnames__WEBPACK_IMPORTED_MODULE_0___default()('loveforever-select', {
  ...
  toogleSelectDeviceType(isMobile = _MatchMedia__WEBPACK_IMPORTED_MODULE_1__["default"].mobile.matches) {
    console.log({
      isMobile
    });
  ...
  bindEvents() {
    _MatchMedia__WEBPACK_IMPORTED_MODULE_1__["default"].mobile.addEventListener('change', event => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ DeleteFittingButton)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./src/utils/index.js");

const ROOT_SELECTOR = '[data-js-delete-fitting-button]';
class DeleteFittingButton {
  selectors = {
    root: ROOT_SELECTOR
  };
  stateSelectors = {
  ...
  onClick = async event => {
    ...
    await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.wait)(2_000);
    const {
      data,
      error
    } = await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.promiseWrapper)(this.deleteFitting(deleteButton));
    console.log({
      data,
      error
    });
...
class Dialog {
  ...
  open(trigger = null) {
    ...
    this.closeCallback = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.lockFocus)(this.dialog);
  ...
  onClick(event) {
    ...
    if (event.target.matches(this.selectors.closeButton) || !event.target.closest('.ui-menu-item') && !event.target.closest(this.selectors.dialogContent)) {
      this.close();
      return;
    }
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DialogCollection);

/***/ }),

/***/ "./src/FavoritesButtonWithCounter.js":
/*!*******************************************!*\
  !*** ./src/FavoritesButtonWithCounter.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FavoritesButtonWithCounterCollection)
/* harmony export */ });
...
class FavoritesButtonWithCounter {
   ...
   */
  constructor(element) {
    var _this$favoritesButton;
    this.favoritesButton = element;
    this.counter = (_this$favoritesButton = this.favoritesButton.querySelector(this.selectors.counter)) !== null && _this$favoritesButton !== void 0 ? _this$favoritesButton : this.favoritesButton;
  ...
  update(count) {
    ...
    this.favoritesButton.classList.toggle(this.stateSelectors.isActive, count > 0);
  }
  bindEvents() {
...
class FavoritesButtonWithCounterCollection {
  /**
  ...
  static init() {
    ...
    buttonsWithCounter.forEach(button => {
      const favoriteButtonsWithCounterInstance = new FavoritesButtonWithCounter(button);
      FavoritesButtonWithCounterCollection.favoriteButtonsWithCounters.set(button, favoriteButtonsWithCounterInstance);
    });
  }
  static destroyAll() {
    FavoritesButtonWithCounterCollection.favoriteButtonsWithCounters.forEach((buttonComponent, element) => {
      buttonComponent.destroy();
      FavoritesButtonWithCounterCollection.favoriteButtonsWithCounters.delete(element);
    });
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FileInputCollection)
/* harmony export */ });
...
class FileInput {
  ...
  constructor(element) {
    ...
    this.filesPreviewContainerElement = this.root.querySelector(this.selectors.filesPreviewContainerElement);
  ...
  removeFileByIndex(index) {
    ...
    this.filesPreviewContainerElement.querySelectorAll(this.selectors.filePreviewElement)[index].remove();
  }
  ...
  onClick(event) {
    if (event.target.closest(this.selectors.removeFileElement)) {
      event.preventDefault();
      const filePreviewElement = event.target.closest(this.selectors.filePreviewElement);
      const filePreviewIndex = Array.from(this.filesPreviewContainerElement.querySelectorAll(this.selectors.filePreviewElement)).indexOf(filePreviewElement);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FilterFittingFormCollection)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./src/utils/index.js");
...
class FilterFittingForm {
  ...
  constructor(element) {
    this.root = element;
    this.fittingContainerElement = this.root.parentElement.querySelector(this.selectors.fittingsContainer);
    this.quickDateSelectButtons = this.root.querySelectorAll(this.selectors.quickDateSelectButton);
  ...
  async filterFittings() {
    if (this.fittingContainerElement.classList.contains(this.stateSelectors.isLoading)) {
      this.abortController.abort();
      this.abortController = new AbortController();
      this.signal = this.abortController.signal;
      this.fittingContainerElement.classList.remove(this.stateSelectors.isLoading);
    ...
    const {
      data,
      error
    } = await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.promiseWrapper)(this.getFilteredFittings());
    console.log({
      data,
      error
    });
  ...
  onClick = event => {
    ...
    dateControl.dispatchEvent(new Event('change', {
      bubbles: true
    }));
  };
  ...
  onReset = event => {
    this.root.reset();
    this.root.querySelectorAll('input:not([type="hidden"])').forEach(input => {
      input.value = '';
  ...
  bindEvents() {
    ...
    this.quickDateSelectButtons.forEach(button => button.addEventListener('click', this.onClick));
  ...
  destroy() {
    ...
    this.quickDateSelectButtons.forEach(button => button.removeEventListener('click', this.onClick));
    document.removeEventListener('updateFittings', this.onChange);
  }
}
class FilterFittingFormCollection {
  /**
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FittingFormCollection: () => (/* binding */ FittingFormCollection)
/* harmony export */ });
/* harmony import */ var _BaseComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BaseComponent */ "./src/BaseComponent.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./src/utils/index.js");
...
class BaseFittingForm extends _BaseComponent__WEBPACK_IMPORTED_MODULE_0__["default"] {
  /**
   *
  ...
  constructor(form) {
    ...
    this.state = this._getProxyState({
      ...
      date: this.form.elements.date instanceof RadioNodeList ? Array.from(this.form.elements.date).find(input => !input.disabled).value : this.form.elements.date.value,
...
class GlobalFittingForm extends BaseFittingForm {
  ...
  constructor(form) {
    ...
    this.slotsContainer = this.form.querySelector(this.selectors.slotsContainer);
    this.prevSlotsButton = this.form.querySelector(this.selectors.prevSlotsButton);
    this.nextSlotsButton = this.form.querySelector(this.selectors.nextSlotsButton);
    ...
    this.dialogTitle = this.closestDialog?.querySelector(this.selectors.dialogTitle);
    this.dialogSelectedTime = this.closestDialog.querySelector(this.selectors.dialogSelectedTime);
    this.state = this._getProxyState({
      ...this.state,
    ...
    this.dialogSelectedTime.textContent = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.formatDateToRussian)(`${this.state.date} ${this.state.time}`);
    this.bindEvents();
  }
  ...
  changeFormHandler(event) {
    ...
    if (target.dataset?.jsFittingFormDateValue) {
      this.form.querySelector(this.selectors.dateInput).value = target.dataset.jsFittingFormDateValue;
    }
  ...
  prevDates() {
    this.state.dateIncrementRatio = this._normalizeDateIncrement(this.state.dateIncrementRatio - 1);
  }
  async submitForm(event) {
    event.preventDefault();
  ...
  updateUI() {
    this.backButton.disabled = this.state.step === 0 || this.state.success === true;
    if (this.prevState.step !== this.state.step) {
      this.openStep(this.state.step);
    }
    if (this.prevState.time !== this.state.time || this.prevState.date !== this.state.date) {
      this.state.step = 1;
    }
    this.slotsContainer.classList.toggle(this.stateSelectors.isLoading, this.state.isUpdatingSlots);
...
class GlobalFittingFormSimpler extends BaseFittingForm {
  ...
  async updateTimeSlots() {
    ...
    const {
      data,
      error
    } = await (0,_utils__WEBPACK_IMPORTED_MODULE_1__.promiseWrapper)(this.getNewTimeSlots());
    if (error) {
      this.state.success = false;
      this.state.error = error.message;
      this.state.isUpdatingSlots = false;
    ...
    for (const time in data.slots) {
      if (Object.prototype.hasOwnProperty.call(data.slots, time)) {
        ...
        timeOptions += `<option value="${time}" ${data.disableSlots && slot.available === 0 ? 'disabled' : ''}>${time} (${slot.available} из ${slot.max_fittings})</option>`;
      }
    }
  ...
  updateUI() {
    ...
    if (this.prevState.isUpdatingSlots !== this.state.isUpdatingSlots && !this.state.isUpdatingSlots) {
      $(this.form.elements.time).selectmenu('refresh');
      $(this.form.elements.time).selectmenu('enable');
      this.form.elements.time.dispatchEvent(new Event('change', {
        bubbles: true,
        cancelable: true
      }));
    }
    this.errorsElement.innerHTML = `<p>${this.state.error}</p>`;
    this.errorsElement.hidden = !Boolean(this.state.error);
    const allFieldChecked = this.state.fitting_type && this.state.phone && this.state.name && this.state.date && this.state.time;
...
class SingleFittingForm extends BaseFittingForm {
  ...
  constructor(form) {
    ...
    this.openDialogButton = this.form.querySelector(this.selectors.openDialogButton);
    this.dialog = document.getElementById(this.openDialogButton.dataset.jsDialogOpenButton);
    this.dialogTitle = this.dialog.querySelector(this.selectors.dialogTitle);
    this.errorsElement = this.dialog.querySelector(this.selectors.errorsElement);
    this.dialogSelectedTime = this.dialog.querySelector(this.selectors.dialogSelectedTime);
    this.submitButton = this.dialog.querySelector(`button[type="submit"][form="${this.form.id}"]`);
    this.dialogFormWrapper = this.dialog.querySelector(this.selectors.dialogFormWrapper);
    ...
    this.state = this._getProxyState({
      ...
      submit_fitting_form_nonce: this.form.elements.submit_fitting_form_nonce.value,
      dialogMessage: 'Запись на примерку',
      isUpdatingSlots: false,
      isSubmitted: false
    });
    ...
    try {
      ...
      for (const time in body.data.slots) {
        if (Object.prototype.hasOwnProperty.call(body.data.slots, time)) {
          ...
          timeOptions += `<option value="${time}" ${slot.available === 0 ? 'disabled' : ''}>${time}</option>`;
        }
      }
      timeSelectControl.innerHTML = timeOptions;
    } catch (error) {
  ...
  updateUI() {
    this.timeControlWrapper.classList.toggle(this.stateSelectors.isLoading, this.state.isUpdatingSlots);
    if (this.state.isUpdatingSlots) {
    ...
    if (this.state.date !== this.prevState.date && !this.state.isUpdatingSlots) {
      this.state.isUpdatingSlots = true;
      this.loadTimeSlots();
    }
    if (this.state.date && this.state.time) {
...
class EditFittingForm extends BaseFittingForm {
  ...
  async updateTimeSlots() {
    if (this.state.isUpdatingSlots) return;
    this.state.isUpdatingSlots = true;
    await (0,_utils__WEBPACK_IMPORTED_MODULE_1__.wait)(2000);
    const {
      data,
      error
    } = await (0,_utils__WEBPACK_IMPORTED_MODULE_1__.promiseWrapper)(this.getNewTimeSlots());
    ...
    for (const time in data.slots) {
      if (Object.prototype.hasOwnProperty.call(data.slots, time)) {
        const slot = data.slots[time];
        timeOptions += `<option value="${time}" ${slot.available === 0 ? 'disabled' : ''}>${time} (Доступно примерок: ${slot.available})</option>`;
      }
    }
    timeSelectControl.innerHTML = timeOptions;
    this.state.isUpdatingSlots = false;
  ...
  submitForm = async event => {
    ...
    const {
      data,
      error
    } = await (0,_utils__WEBPACK_IMPORTED_MODULE_1__.promiseWrapper)(this.updateFitting());
    console.log({
      data,
      error
    });
    ...
    if (error) {
      ...
      this.state.success = true;
      window.location.assign(`${window.location.origin}${window.location.pathname}?updated=true`);
    }
  };
  updateUI() {
    console.log({
    ...
    this.submitButton.disabled = this.state.isSubmitting || this.state.isUpdatingSlots;
    this.submitButton.textContent = this.state.isSubmitting ? 'Обновляем...' : 'Обновить';
    this.errorElement.innerHTML = this.state.error ? `<div class="alert alert--error"><p>${this.state.error}</p></div>` : '';
    this.prevState = {
      ...this.state
    };
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FormsValidator)
/* harmony export */ });
class FormsValidator {
  ...
  manageErrors(fieldControlElement, errorMessages) {
    const fieldErrorsElement = ['radio', 'checkbox'].includes(fieldControlElement.type) ? fieldControlElement.parentElement.parentElement.querySelector(this.selectors.fieldErrors) : fieldControlElement.parentElement.querySelector(this.selectors.fieldErrors);
    console.log({
      fieldErrorsElement,
      fieldControlElement,
      errorMessages
  ...
  validateField(fieldControlElement) {
    if (fieldControlElement.type === 'checkbox' && fieldControlElement.name.endsWith('[]')) {
      const form = fieldControlElement.closest('form');
      const checkboxes = form.querySelectorAll(`input[name="${fieldControlElement.name}"]`);
      const isValid = Array.from(checkboxes).some(checkbox => checkbox.checked);
      this.manageErrors(fieldControlElement, isValid ? [] : [this.errorMessages.valueMissing()]);
...
class InputMask {
  constructor(inputField) {
    ...
    this.imask = (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(this.rootElement, {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (InputMaskCollection);

/***/ }),

/***/ "./src/MaskedPhoneButton.js":
/*!**********************************!*\
  !*** ./src/MaskedPhoneButton.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ MaskedPhoneButtonCollection)
/* harmony export */ });
class MaskedPhoneButtonCollection {
  selectors = {
  ...
  onClick = event => {
    if (event.target.closest(this.selectors.button)) {
      ...
      const phoneElement = document.getElementById(button.dataset.jsPhoneNumberButton);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MatchMedia);

/***/ }),

/***/ "./src/PlayIfVisibleVideoCollection.js":
/*!*********************************************!*\
  !*** ./src/PlayIfVisibleVideoCollection.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PlayIfVisibleVideoCollection)
/* harmony export */ });
const ROOT_SELECTOR = "[data-js-play-if-visible-video]";
class PlayIfVisibleVideoCollection {
  static intersectionObserver = null;
  static init() {
    PlayIfVisibleVideoCollection.intersectionObserver = new IntersectionObserver(videos => {
...
class ProductFilterForm {
  ...
  constructor(element) {
    ...
    this.paginationElement = document.querySelector(this.selectors.paginationElement);
    this.onChange = this.onChange.bind(this);
    this.onSubmit = this.onSubmit.bind(this);
    this.debouncedOnChange = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.debounce)(this.onChange, 200);
  ...
  updateQueryParams(formData) {
    ['action', 'submit_filter_form_nonce', 'taxonomy', 'dress_category'].forEach(key => {
      formData.delete(key);
    });
  ...
  changePaginationLink(event) {
    ...
    const newValue = (_target$dataset$jsPro = target.dataset.jsProductFilterFormPaginateLink) !== null && _target$dataset$jsPro !== void 0 ? _target$dataset$jsPro : 1;
  ...
  resetForm(event) {
    this.resetPage();
    this.filterForm.querySelector('[name="silhouette"]:checked').removeAttribute('checked');
    this.filterForm.querySelector('[name="silhouette"]').setAttribute('checked', '');
    $('#slider').slider('values', [parseInt(this.filterForm.elements['min-price'].min), parseInt(this.filterForm.elements['max-price'].max)]);
    this.filterForm.dispatchEvent(new Event('change', {
      bubbles: true,
      cancelable: true
    }));
  }
  ...
  async getFilteredProducts() {
    ...
    try {
      await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.wait)(1_000);
      const response = await fetch(LOVE_FOREVER.AJAX_URL, {
        method: 'POST',
        body: formData,
        signal
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ProductFilterFormCollection);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RangeSliderCollection)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./src/utils/index.js");
...
class RangeSlider {
  ...
  constructor(element) {
    this.root = element;
    this.minControlElement = this.root.querySelector(this.selectors.minControlElement);
    this.maxControlElement = this.root.querySelector(this.selectors.maxControlElement);
    this.minValueElement = this.root.querySelector(this.selectors.minValueElement);
    this.maxValueElement = this.root.querySelector(this.selectors.maxValueElement);
    ...
    this.customRangeSliderComponent = $(this.selectors.customRangeSliderComponent).slider({
      classes: {
      ...
      slide: (event, ui) => {
        if (this.minValue !== ui.values[0]) {
          ...
          this.minControlElement.dispatchEvent(new Event('change', {
            bubbles: true
          }));
        }
        if (this.maxValue !== ui.values[1]) {
          ...
          this.maxControlElement.dispatchEvent(new Event('change', {
            bubbles: true
          }));
        }
        this.minValueElement.textContent = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.formatPrice)(this.minValue);
        this.maxValueElement.textContent = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.formatPrice)(this.maxValue);
      }
    });
  }
  destroy() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ReviewFormCollection)
/* harmony export */ });
...
class ReviewForm {
  ...
  showErrors(errors) {
    ...
    for (const [name, errorMessage] of Object.entries(errors)) {
      ...
      const errorMessagesElement = targetField.parentElement.querySelector(this.selectors.errorMessageElementSelector);
  ...
  showGlobalError(error) {
    const dialogInstance = _Dialog__WEBPACK_IMPORTED_MODULE_0__["default"].getDialogsById(this.dialogId);
    console.log({
      dialogInstance
    });
    const dialogTitle = dialogInstance.dialog.querySelector('.review-card__title');
    const dialogDescrition = dialogInstance.dialog.querySelector('.review-card__description');
    dialogTitle.textContent = 'Ошибка';
    dialogDescrition.textContent = error;
    dialogInstance.open();
  }
  clearErrors() {
    this.root.querySelectorAll(this.selectors.errorMessageElementSelector).forEach(errorMessagesElement => {
      errorMessagesElement.innerHTML = '';
    });
    this.root.querySelectorAll('[aria-invalid]').forEach(invalidField => {
      invalidField.ariaInvalid = false;
    });
    this.root.parentElement.querySelector(this.selectors.globalErrorElementSelector).style.display = 'none';
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SaleTimerCollection: () => (/* binding */ SaleTimerCollection)
/* harmony export */ });
...
class SaleTimer {
  ...
  constructor(element) {
    ...
    this.minutesWordElement = this.root.querySelector(this.selectors.minuteWord);
    this.secondsWordElement = this.root.querySelector(this.selectors.secondsWord);
    this.deadline = this.root.dataset.jsTimerDeadline ? new Date(parseInt(this.root.dataset.jsTimerDeadline) * 1_000) : new Date();
  ...
  updateTimer = () => {
    ...
    this.daysWordElement.textContent = this.declensionNum(days, ["день", "дня", "дней"]);
    this.hoursWordElement.textContent = this.declensionNum(hours, ["час", "часа", "часов"]);
    this.minutesWordElement.textContent = this.declensionNum(minutes, ["минута", "минуты", "минут"]);
    this.secondsWordElement.textContent = this.declensionNum(seconds, ["секунда", "секунды", "секунд"]);
    if (diff === 0) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SearchFormCollection)
/* harmony export */ });
/* harmony import */ var barba_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! barba.js */ "./node_modules/barba.js/dist/barba.js");
/* harmony import */ var barba_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(barba_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./src/utils/index.js");
...
class SearchForm {
  ...
  constructor(element) {
    ...
    this.searchResultsElement = this.root.parentElement.querySelector(this.selectors.searchResults);
    this.onDebouncedInput = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.debounce)(this.onInput, 500);
    this.bindEvents();
  }
  async queryProducts() {
    const formData = new FormData(this.root);
  ...
  onInput = async event => {
    ...
    const {
      data,
      error
    } = await (0,_utils__WEBPACK_IMPORTED_MODULE_1__.promiseWrapper)(this.queryProducts());
    this.root.classList.remove(this.stateSelectors.isLoading);
    if (error) {
      console.error(error);
      alert(error.message);
  ...
  onSubmit = event => {
    ...
    barba_js__WEBPACK_IMPORTED_MODULE_0___default().Pjax.goTo(`${window.location.origin}/?${queryParams.toString()}`);
  };
  bindEvents() {
...
class Stories {
  ...
  constructor(element, options = {
    ...
    this.holdDelay = 300;
    this.root = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_2__["default"](this.element, {
      width: '465rem',
      perMove: 1,
      perPage: 1,
      pagination: false,
    ...
    this.element.querySelectorAll(this.selectors.innerSlider).forEach((element, index) => {
      const instance = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_2__["default"](element, {
        perPage: 1,
        perMove: 1,
        type: 'fade',
        // autoWidth: true,
  ...
  setupProgressbars = newIndex => {
    ...
    const {
      items
    } = activeStory.Components.Pagination;
  ...
  onRootClick = slide => {
    setTimeout(() => {
      if (this.root.state.is(_splidejs_splide__WEBPACK_IMPORTED_MODULE_2__["default"].STATES.MOVING)) {
        return;
      }
  ...
  onPointerDown = event => {
    ...
    const {
      Autoplay
    } = activeStory.Components;
    const video = this.hasVideo(activeStory.Components.Slides.getAt(activeStory.index).slide);
  ...
  openStory(index = 0) {
    if (index >= this.root.length) {
      _Dialog__WEBPACK_IMPORTED_MODULE_3__["default"].getDialogsById('storiesDialog').close();
      return;
    }
    if (index < 0) {
      index = 0;
  ...
  updateProgress = rate => {
    const activeStory = this.stories.get(this.activeStoryIndex);
    const activePaginationButton = activeStory.Components.Pagination.items[activeStory.index].button;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ VideoPlayerCollection)
/* harmony export */ });
...
/* harmony export */   formatDateToRussian: () => (/* binding */ formatDateToRussian),
...
function lockFocus(element) {
  const focusableElements = element.querySelectorAll('a[href]:not([disabled]), button:not([disabled]), textarea:not([disabled]), input:not([disabled]), select:not([disabled]), [tabindex]:not([tabindex^="-"])');
...
function formatDateToRussian(dateString) {
  ...
  const date = new Date(dateString.replace(/(\d{4})-(\d{2})-(\d{2}) (\d{2}):(\d{2})/, '$1/$2/$3 $4:$5'));
...
/* harmony import */ var _Accordion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Accordion */ "./src/Accordion.js");
/* harmony import */ var _AddToFavoriteButton__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./AddToFavoriteButton */ "./src/AddToFavoriteButton.js");
/* harmony import */ var _CopyToClipboardButton__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CopyToClipboardButton */ "./src/CopyToClipboardButton.js");
/* harmony import */ var _CustomSelect__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./CustomSelect */ "./src/CustomSelect.js");
/* harmony import */ var _DeleteFittingButton__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./DeleteFittingButton */ "./src/DeleteFittingButton.js");
/* harmony import */ var _Dialog__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Dialog */ "./src/Dialog.js");
/* harmony import */ var _FavoritesButtonWithCounter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./FavoritesButtonWithCounter */ "./src/FavoritesButtonWithCounter.js");
/* harmony import */ var _FileInput__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./FileInput */ "./src/FileInput.js");
/* harmony import */ var _FilterFittingForm__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./FilterFittingForm */ "./src/FilterFittingForm.js");
/* harmony import */ var _FittingForm__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./FittingForm */ "./src/FittingForm.js");
/* harmony import */ var _FormValidator__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./FormValidator */ "./src/FormValidator.js");
/* harmony import */ var _InputMask__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./InputMask */ "./src/InputMask.js");
/* harmony import */ var _MaskedPhoneButton__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./MaskedPhoneButton */ "./src/MaskedPhoneButton.js");
/* harmony import */ var _ProductFilterForm__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./ProductFilterForm */ "./src/ProductFilterForm.js");
/* harmony import */ var _RangeSlider__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./RangeSlider */ "./src/RangeSlider.js");
/* harmony import */ var _ReviewForm__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./ReviewForm */ "./src/ReviewForm.js");
/* harmony import */ var _SearchForm__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./SearchForm */ "./src/SearchForm.js");
/* harmony import */ var _styles_index_scss__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./styles/index.scss */ "./src/styles/index.scss");
/* harmony import */ var _VideoPlayer__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./VideoPlayer */ "./src/VideoPlayer.js");
/* harmony import */ var _CardSlider__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./CardSlider */ "./src/CardSlider.js");
/* harmony import */ var _PlayIfVisibleVideoCollection__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./PlayIfVisibleVideoCollection */ "./src/PlayIfVisibleVideoCollection.js");
/* harmony import */ var _SaleTimer__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./SaleTimer */ "./src/SaleTimer.js");
/* harmony import */ var _CustomDatePicker__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./CustomDatePicker */ "./src/CustomDatePicker.js");
/* harmony import */ var _Stories__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./Stories */ "./src/Stories.js");
...
const mutationObserver = new MutationObserver(mutationRecords => {
  for (let i = 0; i < mutationRecords.length; i++) {
    const isSliderDot = mutationRecords[i].target.classList.contains('w-slider-dot');
...
function initHeroPageSliderPagination() {
  document.querySelectorAll('.slider_home-slider.w-slider').forEach(slider => {
...
new _FormValidator__WEBPACK_IMPORTED_MODULE_12__["default"]();
new _MaskedPhoneButton__WEBPACK_IMPORTED_MODULE_14__["default"]();
document.addEventListener('DOMContentLoaded', function () {
  barba_js__WEBPACK_IMPORTED_MODULE_1___default().Pjax.start();
  barba_js__WEBPACK_IMPORTED_MODULE_1___default().Prefetch.init();
  (barba_js__WEBPACK_IMPORTED_MODULE_1___default().Pjax).originalPreventCheck = (barba_js__WEBPACK_IMPORTED_MODULE_1___default().Pjax).preventCheck;
  (barba_js__WEBPACK_IMPORTED_MODULE_1___default().Pjax).preventCheck = function (evt, element) {
    if (!barba_js__WEBPACK_IMPORTED_MODULE_1___default().Pjax.originalPreventCheck(evt, element)) {
      return false;
    }
  ...
  var FadeTransition = barba_js__WEBPACK_IMPORTED_MODULE_1___default().BaseTransition.extend({
    start: function () {
      console.log('transition start');
      this.newContainerLoading.then(this.startTracking.bind(this)).then(this.fadeOut.bind(this)).then(this.fadeIn.bind(this));
    },
    fadeOut: function () {
  ...
  (barba_js__WEBPACK_IMPORTED_MODULE_1___default().Pjax).getTransition = function () {
    return FadeTransition;
  };
  barba_js__WEBPACK_IMPORTED_MODULE_1___default().Dispatcher.on('initStateChange', currentStatus => {
    console.log('initStateChange');
    closeMegaMenu();
    _SearchForm__WEBPACK_IMPORTED_MODULE_18__["default"].destroyAll();
    _FavoritesButtonWithCounter__WEBPACK_IMPORTED_MODULE_8__["default"].destroyAll();
    _CopyToClipboardButton__WEBPACK_IMPORTED_MODULE_4__["default"].destroyAll();
    _CardSlider__WEBPACK_IMPORTED_MODULE_21__["default"].destroyAll();
    _PlayIfVisibleVideoCollection__WEBPACK_IMPORTED_MODULE_22__["default"].destroyAll();
    _InputMask__WEBPACK_IMPORTED_MODULE_13__["default"].destroyAll();
    _Dialog__WEBPACK_IMPORTED_MODULE_7__["default"].destroyAll();
    _Accordion__WEBPACK_IMPORTED_MODULE_2__.AccordionCollection.destroyAll();
    // FittingFormCollection.destroyAll();
    _ProductFilterForm__WEBPACK_IMPORTED_MODULE_15__["default"].destroyAll();
    _RangeSlider__WEBPACK_IMPORTED_MODULE_16__["default"].destroyAll();
    _ReviewForm__WEBPACK_IMPORTED_MODULE_17__["default"].destroyAll();
    _FileInput__WEBPACK_IMPORTED_MODULE_9__["default"].destroyAll();
    _VideoPlayer__WEBPACK_IMPORTED_MODULE_20__["default"].destroyAll();
    _CustomSelect__WEBPACK_IMPORTED_MODULE_5__["default"].destroyAll();
    _FilterFittingForm__WEBPACK_IMPORTED_MODULE_10__["default"].destroyAll();
    _SaleTimer__WEBPACK_IMPORTED_MODULE_23__.SaleTimerCollection.destroyAll();
    _CustomDatePicker__WEBPACK_IMPORTED_MODULE_24__["default"].destroyAll();
  });
  barba_js__WEBPACK_IMPORTED_MODULE_1___default().Dispatcher.on('newPageReady', function (currentStatus, oldStatus, container, newPageRawHTML) {
    const match = newPageRawHTML.match(/data-wf-page="([^"]+)"/);
    const pageId = match ? match[1] : '';
    $('html').attr('data-wf-page', pageId);
  });
  barba_js__WEBPACK_IMPORTED_MODULE_1___default().Dispatcher.on('transitionCompleted', function (currentStatus, prevStatus) {
...
function initPage() {
  _SearchForm__WEBPACK_IMPORTED_MODULE_18__["default"].init();
  _PlayIfVisibleVideoCollection__WEBPACK_IMPORTED_MODULE_22__["default"].init();
  initHeroPageSliderPagination();
  _CardSlider__WEBPACK_IMPORTED_MODULE_21__["default"].init();
  _FavoritesButtonWithCounter__WEBPACK_IMPORTED_MODULE_8__["default"].init();
  _InputMask__WEBPACK_IMPORTED_MODULE_13__["default"].init();
  _Dialog__WEBPACK_IMPORTED_MODULE_7__["default"].init();
  _Accordion__WEBPACK_IMPORTED_MODULE_2__.AccordionCollection.init();
  _CopyToClipboardButton__WEBPACK_IMPORTED_MODULE_4__["default"].init();
  _VideoPlayer__WEBPACK_IMPORTED_MODULE_20__["default"].init();
  _CustomSelect__WEBPACK_IMPORTED_MODULE_5__["default"].init();
  _FittingForm__WEBPACK_IMPORTED_MODULE_11__.FittingFormCollection.init();
  _FilterFittingForm__WEBPACK_IMPORTED_MODULE_10__["default"].init();
  _SaleTimer__WEBPACK_IMPORTED_MODULE_23__.SaleTimerCollection.init();
  _CustomDatePicker__WEBPACK_IMPORTED_MODULE_24__["default"].init();
}
function initCatalogPage() {
  console.log('init catalog page');
  _ProductFilterForm__WEBPACK_IMPORTED_MODULE_15__["default"].init();
  _RangeSlider__WEBPACK_IMPORTED_MODULE_16__["default"].init();
}
...
function initReviewsPage() {
  ...
  _ReviewForm__WEBPACK_IMPORTED_MODULE_17__["default"].init();
  _FileInput__WEBPACK_IMPORTED_MODULE_9__["default"].init();
}
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('load');
  new _AddToFavoriteButton__WEBPACK_IMPORTED_MODULE_3__["default"]();
  new _DeleteFittingButton__WEBPACK_IMPORTED_MODULE_6__["default"]();
  initPage();
  switch (barba_js__WEBPACK_IMPORTED_MODULE_1___default().HistoryManager.currentStatus().namespace) {
    case 'single-dress':
      initSingleDressPage();
    case 'catalog':
      initCatalogPage();
...
window.addEventListener('dialogOpen', event => {
  ...
  if (dialogId === 'storiesDialog') {
    const storiesDialog = _Dialog__WEBPACK_IMPORTED_MODULE_7__["default"].getDialogsById('storiesDialog');
    const trigger = event.detail.trigger;
    const storyNumber = trigger.dataset.jsStoryButton ? parseInt(trigger.dataset.jsStoryButton) : 0;
    const storiesElement = storiesDialog.dialog.querySelector('[data-js-stories]');
    new _Stories__WEBPACK_IMPORTED_MODULE_25__["default"](storiesElement, {
...
function AllPages() {
  ...
  blogSplides.forEach(splideBlogSlider => {
    const splideBlogInstance = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"](splideBlogSlider, {
      // type: 'loop',
      perMove: 1,
      perPage: 1,
      pagination: false,
  ...
  const mobileOnlySplides = document.querySelectorAll('.splide.no-pc:not(.blog)');
  mobileOnlySplides.forEach(mobileOnlySlider => {
    const mobileOnlySplideInstance = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"](mobileOnlySlider, {
      // type: 'loop',
      perMove: 1,
      perPage: 2,
      pagination: false,
  ...
  $('.m-nav-drop').click(function () {
    ...
    $(this).closest('.mob-menu-kee').find('.m-nav-content').css('display', 'flex');
    $(this).closest('.mob-menu-kee').find('.m-nav-content').children('.m-nav-content_in').eq(index).css('display', 'flex');
  });
  $('.m-nav-content_back').click(function () {
    $(this).closest('.mob-menu-kee').children('.m-nav-content').css('display', 'none');
