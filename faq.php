...
?>
    <!DOCTYPE html>
<html data-wf-page="6724cba824e8ec73aed76856" data-wf-site="6720c60d7d5faf3e7ea1ac86">
...
<input type="submit" class="search-button w-button" value="Search"><a href="#" class="clear-search">очистить</a></form>
									...
									<div class="spleet m-none">
										...
										<div class="l-spacer"></div>
										<div class="menu-line p-12-12 white uper rev n-voreder"><a href="/atele" class="n-menu w-nav-link">Ателье</a><a href="/blog" class="n-menu w-nav-link">блог</a><a href="/faq" aria-current="page" class="n-menu w-nav-link w--current">вопрос-ответ</a><a href="/otzivs" class="n-menu w-nav-link">отзывы</a><a href="/contacts" class="n-menu w-nav-link">контакты</a>
...
<input type="submit" class="search-button w-button" value="Search"><a href="#" class="clear-search">очистить</a></form>
						...
						<div class="page-top">
							<div class="horiz">
								...
								<div class="p-12-12 uper">вопрос-ответ</div>
							</div>
				...
				<section class="section">
					<div class="container n-top">
						<div data-current="Tab 1" data-easing="ease" data-duration-in="300" data-duration-out="100" class="w-tabs">
							<div class="tabs-menu w-tab-menu"><a data-w-tab="Tab 1" class="faq-btn w-inline-block w-tab-link w--current"><div class="p-12-12 uper m-12-12">все</div></a><a data-w-tab="Tab 2" class="faq-btn w-inline-block w-tab-link"><div class="p-12-12 uper m-12-12">возврат</div></a><a data-w-tab="Tab 3" class="faq-btn w-inline-block w-tab-link"><div class="p-12-12 uper m-12-12">доставка</div></a><a data-w-tab="Tab 4" class="faq-btn w-inline-block w-tab-link"><div class="p-12-12 uper m-12-12">доставка</div></a><a data-w-tab="Tab 5" class="faq-btn w-inline-block w-tab-link"><div class="p-12-12 uper m-12-12">доставка</div></a><a data-w-tab="Tab 6" class="faq-btn w-inline-block w-tab-link"><div class="p-12-12 uper m-12-12">доставка</div></a></div>
