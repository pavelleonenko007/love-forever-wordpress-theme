		...
		<div class="vert-menu">
			...
			<div class="spleet m-none">
				...
				<div class="menu-line p-12-12 white uper rev">
					...
					<?php endif; ?>
					<?php
					if ( ! empty( TELEGRAM_LINK ) || ! empty( VK_LINK ) || ! empty( INSTAGRAM_LINK ) || ! empty( WHATSAPP_LINK ) ) :
						?>
						<div class="head-soc-menu">
							<?php if ( ! empty( TELEGRAM_LINK ) ) : ?>
								<a href="<?php echo esc_url( TELEGRAM_LINK ); ?>" aria-label="Ссылка на телеграм чат" class="head-soc-link w-inline-block" target="_blank" rel="nofollow">
							...
							<?php if ( ! empty( VK_LINK ) ) : ?>
								<a href="<?php echo esc_url( VK_LINK ); ?>" aria-label="Ссылка на группу в VK" class="head-soc-link w-inline-block" target="_blank" rel="nofollow">
									<div class="head-soc-link_link w-embed">
							...
							<?php if ( ! empty( INSTAGRAM_LINK ) ) : ?>
								<a href="<?php echo esc_url( INSTAGRAM_LINK ); ?>" aria-label="Ссылка на Instagram профиль" class="head-soc-link w-inline-block" target="_blank" rel="nofollow">
									<div class="head-soc-link_link w-embed">
							...
							<?php if ( ! empty( WHATSAPP_LINK ) ) : ?>
								<a href="<?php echo esc_url( WHATSAPP_LINK ); ?>" aria-label="Ссылка на чат в WhatsApp" class="head-soc-link w-inline-block" target="_blank" rel="nofollow">
									<div class="head-soc-link_link w-embed">
										<svg width="100%" height="100%" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
