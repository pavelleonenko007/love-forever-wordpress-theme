<?php
/*
Template name: Otzivs
*/
?>
    <!DOCTYPE html>
<html data-wf-page="67249dc1fa10238682ee40ae" data-wf-site="6720c60d7d5faf3e7ea1ac86">
...
.select::-ms-expand {
  display: none;
		...
		<div id="barba-wrapper" class="wrapper">
			<div class="barba-container otzivs-page">
...
<input type="submit" class="search-button w-button" value="Search"><a href="#" class="clear-search">очистить</a></form>
									...
									<div class="spleet m-none">
										...
										<div class="l-spacer"></div>
										<div class="menu-line p-12-12 white uper rev n-voreder"><a href="/atele" class="n-menu w-nav-link">Ателье</a><a href="/blog" class="n-menu w-nav-link">блог</a><a href="/faq" class="n-menu w-nav-link">вопрос-ответ</a><a href="/otzivs" aria-current="page" class="n-menu w-nav-link w--current">отзывы</a><a href="/contacts" class="n-menu w-nav-link">контакты</a>
							...
							<div class="fixed-navbar menuline">
								<div class="vert-menu">
									<div class="spleet m-none">
										...
										<div class="menu-line p-12-12 white uper rev n-voreder"><a href="/atele" class="n-menu w-nav-link">аксессуары</a><a href="/blog" class="n-menu w-nav-link">Ателье</a><a href="/otzivs" aria-current="page" class="n-menu w-nav-link w--current">отзывы</a>
											<div class="horiz">
												<div>8 812 425 22 75</div><a href="#" class="show-all-btn">показать</a></div>
...
<input type="submit" class="search-button w-button" value="Search"><a href="#" class="clear-search">очистить</a></form>
						...
						<div class="slider_home-slider_slide-in">
							<div class="mom-abs"><img src="<?php echo get_template_directory_uri() ?>/images/FD0BDD0BDD18BD0B8CC86-1_D09CD0BED0BDD182D0B0D0B6D0BDD0B0D18F20D0BED0B1D0BBD0B0D181D182D18C20120D0BAD0BED0BFD0B8D18F2029201.avif" loading="eager" alt class="img-cover"></div>
							<div class="slider-bottom-content">
								<div class="horiz">
									<div class="p-12-12 uper">салон love forever</div>
									<div class="indirm-line_romb"></div>
									<div class="p-12-12 uper">отзывы</div>
								</div>
								<h1 class="p-86-96">отзывы</h1>
								<p class="p-16-20 mmax480">Мы очень любим невест и всегда стараемся выяснить, что им понравилось,  а что нет. Собрали отзывы о салоне и фотографии со свадеб наших невест</p><a href="#" class="btn in-slider-btn w-inline-block"><div>оставить отзыв</div></a></div>
						</div>
					</div>
				</section>
					...
					<div class="container n-top">
						<div class="otzivi-grid otzivi-flex">
							<div class="oyziv-item">
								<div data-delay="4000" data-animation="slide" class="slider-oyziv w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
									<div class="slider-oyziv_mask w-slider-mask">
										<div class="w-slide">
											<div class="slider-oyziv_img-mom"><img src="<?php echo get_template_directory_uri() ?>/images/6721fb71c48ed057ca993543_Group20184.avif" loading="lazy" alt class="img-cover"></div>
										</div>
										<div class="w-slide">
											<div class="slider-oyziv_img-mom"><img src="<?php echo get_template_directory_uri() ?>/images/6721f9fb9790abdc56ba8ee1_Group20365.avif" loading="lazy" alt class="img-cover"></div>
										</div>
									</div>
								...
								<div class="vert">
									...
									<p class="p-16-20 italic">Замечательное место, есть напитки и закуски, вежливый персонал, большой  выбор платьев, все очень понравилось! Находится близко к метро, сразу  пришла и меня начали обслуживать</p>
								</div>
							</div>
							<div class="oyziv-item no-image">
								<div class="vert">
									<div class="otziv-horiz no-image">
										<div class="p-12-12 uper">татьяна</div>
										<div class="_2px_romb purp _2"></div>
										<div class="p-12-12 uper">22.09.24</div>
										<div class="likes-line">
											<div class="likes-svg l4 w-embed">
												<svg width="16" height="14" viewbox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path fill-rule="evenodd" clip-rule="evenodd" d="M1.28444 1.26599C-0.428147 2.95398 -0.428147 5.69069 1.28444 7.37868L8.00225 14L14.204 7.88731L14.2018 7.8851L14.7156 7.37868C16.4281 5.69069 16.4281 2.95398 14.7156 1.26599C13.003 -0.421998 10.2263 -0.421998 8.51374 1.26599L8 1.77236L7.48626 1.26599C5.77367 -0.421998 2.99703 -0.421998 1.28444 1.26599Z" fill="#F22EA9"></path>
												</svg>
												<svg width="16" height="14" viewbox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<div class="oyziv-item">
								...
								<div class="vert">
									<div class="otziv-horiz">
										<div class="p-12-12 uper">Ольга</div>
										<div class="_2px_romb purp"></div>
										<div class="p-12-12 uper">22.09.24</div>
										<div class="likes-line">
											<div class="likes-svg l3 w-embed">
												<svg width="16" height="14" viewbox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path fill-rule="evenodd" clip-rule="evenodd" d="M1.28444 1.26599C-0.428147 2.95398 -0.428147 5.69069 1.28444 7.37868L8.00225 14L14.204 7.88731L14.2018 7.8851L14.7156 7.37868C16.4281 5.69069 16.4281 2.95398 14.7156 1.26599C13.003 -0.421998 10.2263 -0.421998 8.51374 1.26599L8 1.77236L7.48626 1.26599C5.77367 -0.421998 2.99703 -0.421998 1.28444 1.26599Z" fill="#F22EA9"></path>
												</svg>
												<svg width="16" height="14" viewbox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<p class="p-16-20 italic">Обалденный салон! Нашла платье своей мечты))) Спасибо огромное Алине, которая помогла со всем и даже больше!</p>
								</div>
							</div>
							<div class="oyziv-item">
								<div data-delay="4000" data-animation="slide" class="slider-oyziv w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
							...
							<div class="oyziv-item"><img src="<?php echo get_template_directory_uri() ?>/images/6721f9fb9790abdc56ba8ee1_Group20365.avif" loading="lazy" alt class="img-fw">
								<div class="vert">
									<div class="otziv-horiz">
										<div class="p-12-12 uper">Ольга</div>
										<div class="_2px_romb purp"></div>
							...
							<div class="oyziv-item no-image">
								<div class="vert">
									...
									<p class="p-16-20 italic">Так получилось, что изначально я вообще не планировала покупать платье.  Наша свадьба состоялась 29 января 2022 года, и я думала прийти в обычном  брючном костюме и просто расписаться с женихом в ЗАГСе. Но наши мамы  решили иначе, и буквально за 20 дней до свадьбы потащили меня в салон -  ваш. Первый и единственный. И я не пожалела. Я не могу не отметить Ваше ателье, которое  оперативно и в сжатые сроки помогло доработать платье и сделать его  абсолютно идеальным по длине и посадке. Спасибо вам за всё -  оперативность, отзывчивость, терпеливость и лояльность! Процветания!</p>
								</div>
							</div>
						</div>
				...
				<section class="section">
					<div class="container">
						...
						<div class="spleet spleet-top">
							...
							<div class="otz-form-block w-form">
								<form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="67249dc1fa10238682ee40ae" data-wf-element-id="d744d5e4-a65e-3d82-0a54-f293122549ec">
<input class="input w-input" maxlength="256" name="name" data-name="Name" placeholder="имя" type="text" id="name" required>
<input class="input w-input" maxlength="256" name="date" data-name="date" placeholder="Дата" type="text" id="date" required>
									<div class="relaive">
<textarea placeholder="Ваш отзыв" maxlength="5000" id="field" name="field" data-name="Field" class="input textarea w-input"></textarea>
										<div class="code-embed-6 w-embed">
											<div class="input-file-row">
<label class="input-file"> <svg width="18" height="14" viewbox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M17.8182 0L0 1.33514e-06V0.700001V13.3V14H0.742424H17.0758H17.8182L17.8182 13.3V0.7V0ZM0.742424 12.2695L0.742424 0.700001H17.0758L17.0758 12.8538L13.1515 9.15385L12.6266 9.64883L16.499 13.3L0.742424 13.3L6.11996 7.82186L10.342 11.8027L10.867 11.3077L13.1514 9.15386L12.6264 8.65889L10.342 10.8127L6.62463 7.30775L6.62468 7.3077L6.07982 6.83222L0.742424 12.2695ZM14.8485 3.5C14.8485 3.8866 14.5161 4.2 14.1061 4.2C13.696 4.2 13.3636 3.8866 13.3636 3.5C13.3636 3.1134 13.696 2.8 14.1061 2.8C14.5161 2.8 14.8485 3.1134 14.8485 3.5ZM15.5909 3.5C15.5909 4.2732 14.9261 4.9 14.1061 4.9C13.286 4.9 12.6212 4.2732 12.6212 3.5C12.6212 2.7268 13.286 2.1 14.1061 2.1C14.9261 2.1 15.5909 2.7268 15.5909 3.5Z" fill="black"></path></svg> 
<input type="file" name="file" multiple accept="image/*"> </label>
...
<input type="submit" data-wait="отправка..." class="btn send-btn w-button" value="отправить">
										<div class="p-12-12 uper op03 m-12-12">Нажимая отправить вы соглашаетесь с политикой конфиденциальности</div>
									</div>
								</form>
				...
				<div class="succes-block">
					<div class="succes-div"><img src="<?php echo get_template_directory_uri() ?>/images/672b6e5326479af83bdbf512_Group20441.svg" loading="lazy" alt class="image-4">
						<div class="p-21-21">Отзыв успешно отправлен</div>
						<p class="p-16-20">Ваш отзыв будет опубликован в течение 48 часов после нашей проверки. Спасибо за понимание!</p><a href="#" class="btn in-single-btn close-sucess w-inline-block"><div>хорошо</div></a></div>
				</div>
			</div>
		</div>
