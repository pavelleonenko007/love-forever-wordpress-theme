					...
					<div class="container container-fw n-top">
							...
							<header class="header menuline">
								<div class="vert-menu">
									...
									<div class="spleet m-none">
										...
										<div class="l-spacer"></div>
										<div class="menu-line p-12-12 white uper rev n-voreder">
											<a href="/atele" class="n-menu w-nav-link">Ателье</a><a href="/blog" class="n-menu w-nav-link">блог</a><a href="/faq" class="n-menu w-nav-link">вопрос-ответ</a><a href="/otzivs" aria-current="page" class="n-menu w-nav-link w--current">отзывы</a><a href="/contacts" class="n-menu w-nav-link">контакты</a>
											<div class="div-block-5">
												<div class="menu-link-keeper">
													<a href="#" class="serach-btn w-inline-block">
														<div class="code-embed-3 w-embed">
							...
							<div class="fixed-navbar menuline">
								<div class="vert-menu">
									<div class="spleet m-none">
										...
										<div class="menu-line p-12-12 white uper rev n-voreder">
											<a href="/atele" class="n-menu w-nav-link">аксессуары</a><a href="/blog" class="n-menu w-nav-link">Ателье</a><a href="/otzivs" aria-current="page" class="n-menu w-nav-link w--current">отзывы</a>
											<div class="horiz">
												<div>8 812 425 22 75</div>
												<a href="#" class="show-all-btn">показать</a>
											</div>
						...
						<div class="slider_home-slider_slide-in">
							...
							<div class="slider-bottom-content">
								...
								<p class="p-16-20 mmax480">Мы очень любим невест и всегда стараемся выяснить, что им понравилось,  а что нет. Собрали отзывы о салоне и фотографии со свадеб наших невест</p>
