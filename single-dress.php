...
?>
<!DOCTYPE html>
<html data-wf-page="67239bd83c4331a3450cc872" data-wf-site="6720c60d7d5faf3e7ea1ac86">
					...
					<div class="container n-top">
						...
						<div class="spleet m-h-vert">
							<div class="code-embed-2 w-embed">
								<nav aria-label="Breadcrumb" class="breadcrumb">
									<ul>
										<li><a href="#">салон love forever</a></li>
										<li><a href="#">свадебные платья</a></li>
										<li><span aria-current="page">Свадебное платье Даниэль</span></li>
									</ul>
								</nav>
							</div>
								...
								<div class="m-prod-slider_mask w-slider-mask">
									...
									<div class="w-slide">
										<div class="last-slide">
											<img src="<?php echo get_template_directory_uri(); ?>/images/673491b1eafc564cecd9ec1f_Group20647.svg" loading="lazy" alt class="image-5">
											<div class="p-12-12 uper m-12-12">силуэт русалка</div>
											<div class="p-86-96 m-86-86">177</div>
											<div class="p-16-20 m-16-20">платьев</div>
											<a href="#" class="link-block-4 w-inline-block">
												<div>перейти к каталогу</div>
												<div class="code-embed-11 w-embed">
													<svg xmlns="http://www.w3.org/2000/svg" width="4" height="6" viewbox="0 0 4 6" fill="none">
														<path fill-rule="evenodd" clip-rule="evenodd" d="M3.41604 3.51284L0.583958 6L0 5.48716L2.83208 3L0 0.512837L0.583958 0L3.41604 2.48716L4 3L3.41604 3.51284Z" fill="white"></path>
													</svg>
												</div>
											</a>
										</div>
							...
							<div class="single-right-block">
								<div class="p-12-12 single-right-highl m-12-12">есть в наличии</div>
						...
						<div class="single-prod-grid">
							<div class="single-images">
								<div class="single-img-mom"><img src="<?php echo get_template_directory_uri(); ?>/images/67248e494e773f5c2bbeab1f_Group20184.avif" loading="lazy" alt class="img-fw"></div>
								<div class="single-img-mom"><img src="<?php echo get_template_directory_uri(); ?>/images/67248e4a97ea03b0819eef08_Group20246.avif" loading="lazy" alt class="img-fw"></div>
								<div class="single-img-mom"><img src="<?php echo get_template_directory_uri(); ?>/images/67248e49c49c2c9c7507fcae_Group20247.avif" loading="lazy" alt class="img-fw"></div>
							</div>
							<div class="single-content">
								<div class="single-styk">
									<div class="p-12-12 uper m-12-12">twiggy</div>
									<h1 class="p-24-24 h-single">Свадебное платье Даниэль</h1>
									<div class="horiz">
										<a href="#" class="btn-color w-inline-block">
											...
											<div class="p-12-12 uper m-12-12">бежевый</div>
										</a>
										<a href="#" class="btn-color active w-inline-block">
											<div class="color-mom">
												<div class="color-dot _2-copy">
													<div class="color-dot_in"></div>
												</div>
											</div>
											<div class="p-12-12 uper m-12-12">белый</div>
										</a>
										<a href="#" class="btn-color w-inline-block">
											<div class="color-mom">
												<div class="color-dot _3">
													<div class="color-dot_in"></div>
												</div>
											</div>
											<div class="p-12-12 uper m-12-12">красный</div>
										</a>
									</div>
									<div class="horiz">
										<div class="p-24-24">37 500 ₽</div>
										<div class="p-24-24 indirim-p-24-24">53 500 ₽</div>
										<div class="indirim-single">
											<div class="p-12-12 uper m-12-12">-40%</div>
										</div>
									</div>
									<p class="p-16-20 odescr">Свадебное платье А-силуэта с длинными рукавами и воротником-стоечкой. Спинка на пуговицах и молнии. <br><br>Основной материал: атлас, кружево</p>
									...
									<div class="horiz shere-line">
										...
										<div class="share-block">
											<a href="#" class="share-btn w-inline-block">
												<div class="svg-share w-embed">
													<svg width="16" height="10" viewbox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
														<path d="M8.71455 10C3.24797 10 0.129919 6.24625 0 0H2.73829C2.82823 4.58458 4.84697 6.52653 6.44597 6.92693V0H9.02436V3.95395C10.6034 3.78378 12.2623 1.98198 12.822 0H15.4004C15.1895 1.02791 14.7691 2.00118 14.1655 2.85893C13.562 3.71668 12.7882 4.44045 11.8926 4.98498C12.8923 5.48254 13.7753 6.18678 14.4833 7.05125C15.1913 7.91571 15.7082 8.92073 16 10H13.1618C12.8999 9.06258 12.3676 8.22343 11.6316 7.58773C10.8956 6.95203 9.9886 6.54805 9.02436 6.42643V10H8.71455Z" fill="black"></path>
													</svg>
									...
									<div class="cats-horiz">
										...
										<a href="#" class="btn grey-border_btn in-single w-inline-block">
											<div>#с длинным рукавом белый</div>
										</a>
										<a href="#" class="btn grey-border_btn in-single w-inline-block">
											<div>#атлас</div>
										</a>
						...
						<div class="splide y-pc">
							<div class="splide__track">
								<div class="splide__list search-grid">
									...
									<div id="w-node-f2a03f55-cf72-e124-8648-e74d9b1c177a-450cc872" class="splide__slide">
										<div id="w-node-f2a03f55-cf72-e124-8648-e74d9b1c177b-450cc872" class="prod-item">
											<div class="prod-item_top">
									...
									<div id="w-node-f2a03f55-cf72-e124-8648-e74d9b1c179b-450cc872" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
									...
									<div id="w-node-f2a03f55-cf72-e124-8648-e74d9b1c179d-450cc872" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
									...
									<div id="w-node-_5235af27-82f0-642b-1333-83d5af6c2df3-450cc872" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
				...
				<section class="section">
					<div class="container">
						...
						<div class="splide y-pc">
							<div class="splide__track">
								<div class="splide__list search-grid">
									<div id="w-node-e82ecd6a-f9d0-8feb-56ec-886a8749882a-450cc872" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
									...
									<div id="w-node-e82ecd6a-f9d0-8feb-56ec-886a8749882c-450cc872" class="splide__slide">
										<div id="w-node-e82ecd6a-f9d0-8feb-56ec-886a8749882d-450cc872" class="prod-item">
											<div class="prod-item_top">
												<div data-delay="4000" data-animation="slide" class="slider w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
													<div class="w-slider-mask">
														<div class="w-slide">
									...
									<div id="w-node-e82ecd6a-f9d0-8feb-56ec-886a8749884d-450cc872" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
									...
									<div id="w-node-e82ecd6a-f9d0-8feb-56ec-886a8749884f-450cc872" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
									...
									<div id="w-node-_21e19b6d-8fbf-12ff-12ad-d494450d00cf-450cc872" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
