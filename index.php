...
?>
<!DOCTYPE html>
<html data-wf-page="6720c60d7d5faf3e7ea1ac8d" data-wf-site="6720c60d7d5faf3e7ea1ac86">
	...
	<body class="body">
		...
		<div id="barba-wrapper" class="wrapper">
			<div class="barba-container home-page">
				<section class="section section_100vh homepagesection">
					<div class="container container-fw n-top">
						<a href="#" class="indirm-line w-inline-block">
							<div class="marq">
								<div class="marq-line">
									<div class="indirm-line_div">
										<div>распродажа до 70%</div>
								...
								<div class="vert-menu">
															...
															<div class="m-nav-cats">
																<div class="m-nav-drops">
																	<a href="#" class="m-nav-drop-btn w-inline-block">
																		<div>силуэт</div>
																		<img src="<?php echo get_template_directory_uri(); ?>/images/673dc9a4d3949ca7d7c90f76_Union.svg" loading="eager" alt class="image-6-drop">
																	</a>
															...
															<div class="m-nav-keep">
																<div class="m-nav-top">
																	<a href="#" class="m-nav-drop w-inline-block">
																		...
																		<img src="<?php echo get_template_directory_uri(); ?>/images/673dc676af0eceedf43e40c1_Union.svg" loading="eager" alt class="image-6">
																	</a>
																	<a href="#" class="m-nav-drop w-inline-block">
																		<div>вечерние платья</div>
																		<img src="<?php echo get_template_directory_uri(); ?>/images/673dc676af0eceedf43e40c1_Union.svg" loading="eager" alt class="image-6">
																	</a>
																	<a href="#" class="m-nav-drop w-inline-block">
																		<div>выпускные платья</div>
																		<img src="<?php echo get_template_directory_uri(); ?>/images/673dc676af0eceedf43e40c1_Union.svg" loading="eager" alt class="image-6">
																	</a>
																	<a href="#" class="m-nav-drop w-inline-block">
																		<div>аксессуары</div>
																	...
																	<a href="#" class="m-nav-a w-inline-block">
																		<div>распродажа <span class="indirim-span">до 70 %</span></div>
																	</a>
																	<a href="#" class="m-nav-a w-inline-block">
																		<div>распродажа</div>
																	</a>
															...
															<div class="m-nav-content">
																<div class="m-nav-content_in">
																	<a href="#" class="m-nav-content_back w-inline-block">
																		<img src="<?php echo get_template_directory_uri(); ?>/images/673dc840b23caa30509cbdf5_Union.svg" loading="eager" alt class="image-7">
																		<div class="p-12-12 uper m-12-12">свадебные платья</div>
																	</a>
																	<a href="#" class="m-nav-a long w-inline-block">
																	...
																	<div class="div-block-12">
																		<a href="#" class="choosed-item w-inline-block">
																			<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/67248e4a97ea03b0819eef08_Group20246.avif" loading="lazy" alt class="img-cover"></div>
																			<div class="choosed-item_bottom">
																				<div>Свадебное платье Даниэль</div>
																				<div class="text-block">32 900 ₽</div>
																			</div>
																		</a>
																		<a href="#" class="choosed-item w-inline-block">
																			<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/67248e4a97ea03b0819eef08_Group20246.avif" loading="lazy" alt class="img-cover"></div>
																...
																<div class="m-nav-content_in">
																	<a href="#" class="m-nav-content_back w-inline-block">
																		<img src="<?php echo get_template_directory_uri(); ?>/images/673dc840b23caa30509cbdf5_Union.svg" loading="eager" alt class="image-7">
																		<div class="p-12-12 uper m-12-12">вечерние платья</div>
																	</a>
																	<a href="#" class="m-nav-a long w-inline-block">
																		<div>СМОТРЕТЬ ВСЕ</div>
																		<img src="<?php echo get_template_directory_uri(); ?>/images/673dc676af0eceedf43e40c1_Union.svg" loading="eager" alt class="image-6">
									...
									<div class="spleet m-none">
										<div class="menu-line p-12-12 white uper n-voreder">
											<div class="menu-link-keeper">
												...
												<div class="hovered-menue">
													...
													<div id="w-node-_144563be-6001-1af8-6446-1240953da8a7-be61d3ef" class="m-h-vert">
														<div class="p-16-16">стиль</div>
														<div id="w-node-_144563be-6001-1af8-6446-1240953da8aa-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>открытые</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_144563be-6001-1af8-6446-1240953da8c3-be61d3ef" class="m-h-vert">
														<div class="p-16-16">ткань</div>
														<div id="w-node-_144563be-6001-1af8-6446-1240953da8c6-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>Фатин</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_144563be-6001-1af8-6446-1240953da8d9-be61d3ef" class="m-h-vert">
														<div class="p-16-16">топ бренды</div>
														<div id="w-node-_144563be-6001-1af8-6446-1240953da8dc-be61d3ef" class="m-h-vert grider">
															<a href="#" class="a-12-12 w-inline-block">
																<div>AVE</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
															...
															<a id="w-node-_144563be-6001-1af8-6446-1240953da8f5-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>Kookla</div>
															</a>
															<a id="w-node-_144563be-6001-1af8-6446-1240953da8f8-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>S. markelova</div>
															</a>
															<a id="w-node-_144563be-6001-1af8-6446-1240953da8fb-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>milva</div>
															</a>
															<a id="w-node-_144563be-6001-1af8-6446-1240953da8fe-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>Divino Rose</div>
															</a>
															<a id="w-node-_144563be-6001-1af8-6446-1240953da901-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>S. markelova</div>
															</a>
														</div>
													</div>
											...
											<div class="menu-link-keeper">
												<a href="#" class="n-menu w-nav-link">вечерние</a>
												<div class="hovered-menue">
													<div id="w-node-_144563be-6001-1af8-6446-1240953da935-be61d3ef" class="m-h-vert">
														<div class="p-16-16">силуэт 2</div>
														<div id="w-node-_144563be-6001-1af8-6446-1240953da938-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>а-силуэт</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_144563be-6001-1af8-6446-1240953da951-be61d3ef" class="m-h-vert">
														<div class="p-16-16">стиль</div>
														<div id="w-node-_144563be-6001-1af8-6446-1240953da954-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>открытые</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_144563be-6001-1af8-6446-1240953da96d-be61d3ef" class="m-h-vert">
														<div class="p-16-16">ткань</div>
														<div id="w-node-_144563be-6001-1af8-6446-1240953da970-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>Фатин</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_144563be-6001-1af8-6446-1240953da983-be61d3ef" class="m-h-vert">
														<div class="p-16-16">топ бренды</div>
														<div id="w-node-_144563be-6001-1af8-6446-1240953da986-be61d3ef" class="m-h-vert grider">
															<a href="#" class="a-12-12 w-inline-block">
																<div>AVE</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
															...
															<a id="w-node-_144563be-6001-1af8-6446-1240953da99f-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>Kookla</div>
															</a>
															<a id="w-node-_144563be-6001-1af8-6446-1240953da9a2-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>S. markelova</div>
															</a>
															<a id="w-node-_144563be-6001-1af8-6446-1240953da9a5-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>milva</div>
															</a>
															<a id="w-node-_144563be-6001-1af8-6446-1240953da9a8-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>Divino Rose</div>
															</a>
															<a id="w-node-_144563be-6001-1af8-6446-1240953da9ab-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>S. markelova</div>
															</a>
														</div>
													</div>
													<div id="w-node-_144563be-6001-1af8-6446-1240953da9ae-be61d3ef" class="m-h-vert">
														<div class="p-16-16">стоимость</div>
														<div id="w-node-_144563be-6001-1af8-6446-1240953da9b1-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>10 000 ₽ - 20 000 ₽</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_144563be-6001-1af8-6446-1240953da9c1-be61d3ef" class="menu-choosed-items">
														<a href="#" class="choosed-item w-inline-block">
															<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/67248e4a97ea03b0819eef08_Group20246.avif" loading="lazy" alt class="img-cover"></div>
															<div class="choosed-item_bottom">
																<div>Свадебное платье Даниэль</div>
										...
										<div class="l-spacer"></div>
										<div class="menu-line p-12-12 white uper rev n-voreder">
											<a href="/atele" class="n-menu w-nav-link">Ателье</a><a href="/blog" class="n-menu w-nav-link">блог</a><a href="/faq" class="n-menu w-nav-link">вопрос-ответ</a><a href="/otzivs" class="n-menu w-nav-link">отзывы</a><a href="/contacts" class="n-menu w-nav-link">контакты</a>
											<div class="div-block-5">
												<div class="menu-link-keeper">
													<a href="#" class="serach-btn w-inline-block">
														<div class="code-embed-3 w-embed">
												...
												<a href="#" class="head-soc-link w-inline-block">
													<div class="head-soc-link_link w-embed">
														<svg width="100%" height="100%" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
															<path d="M11.53 0H4.4282C2.00522 0 0 2.00522 0 4.4282V11.5718C0 13.9948 2.00522 16 4.4282 16H11.53C13.953 16 15.9582 13.9948 16 11.5718V4.46997C16 2.00522 13.9948 0 11.53 0ZM7.97911 11.7807C5.89034 11.7807 4.21932 10.1097 4.21932 8.02089C4.21932 5.93212 5.89034 4.30287 7.93734 4.30287C9.98433 4.30287 11.6554 5.97389 11.6554 8.02089C11.6554 10.0679 10.0261 11.7807 7.97911 11.7807ZM13.8277 3.92689C13.4935 4.46997 12.7833 4.67885 12.282 4.34465C11.7389 4.01044 11.53 3.30026 11.8642 2.79896C12.1984 2.25587 12.9086 2.047 13.4099 2.3812C13.953 2.67363 14.1201 3.38381 13.8277 3.92689Z" fill="white"></path>
														</svg>
													</div>
												</a>
												<a href="#" class="head-soc-link w-inline-block">
													<div class="head-soc-link_link w-embed">
														<svg width="100%" height="100%" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
															<path d="M13.6585 2.33333C12.1533 0.833333 10.1463 0 8.02787 0C3.62369 0 0.0557483 3.55556 0.0557483 7.94444C0.0557483 9.33333 0.445993 10.7222 1.11498 11.8889L0 16L4.23694 14.8889C5.40767 15.5 6.68989 15.8333 8.02787 15.8333C12.4321 15.8333 16 12.2778 16 7.88889C15.9443 5.83333 15.1638 3.83333 13.6585 2.33333ZM11.8746 10.7778C11.7073 11.2222 10.9268 11.6667 10.5366 11.7222C10.2021 11.7778 9.7561 11.7778 9.31011 11.6667C9.03136 11.5556 8.64112 11.4444 8.19512 11.2222C6.18815 10.3889 4.90592 8.38889 4.79443 8.22222C4.68293 8.11111 3.95819 7.16667 3.95819 6.16667C3.95819 5.16667 4.45993 4.72222 4.62718 4.5C4.79443 4.27778 5.01742 4.27778 5.18467 4.27778C5.29617 4.27778 5.46341 4.27778 5.57491 4.27778C5.68641 4.27778 5.85366 4.22222 6.02091 4.61111C6.18815 5 6.5784 6 6.63415 6.05556C6.68989 6.16667 6.68989 6.27778 6.63415 6.38889C6.5784 6.5 6.52265 6.61111 6.41115 6.72222C6.29965 6.83333 6.18815 7 6.1324 7.05556C6.0209 7.16667 5.90941 7.27778 6.02091 7.44444C6.1324 7.66667 6.52265 8.27778 7.13589 8.83333C7.91638 9.5 8.52962 9.72222 8.75261 9.83333C8.97561 9.94445 9.08711 9.88889 9.1986 9.77778C9.3101 9.66667 9.70035 9.22222 9.81185 9C9.92335 8.77778 10.0906 8.83333 10.2578 8.88889C10.4251 8.94444 11.4286 9.44445 11.5958 9.55556C11.8188 9.66667 11.9303 9.72222 11.9861 9.77778C12.0418 9.94444 12.0418 10.3333 11.8746 10.7778Z" fill="white"></path>
														</svg>
													</div>
												</a>
											</div>
							...
							<div class="fixed-navbar menuline">
								<div class="vert-menu">
									<div class="spleet m-none">
											...
											<div class="menu-link-keeper">
												...
												<div class="hovered-menue">
													<div id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6905-be61d3ef" class="m-h-vert">
														<div class="p-16-16">силуэт</div>
														<div id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6908-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>а-силуэт</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6921-be61d3ef" class="m-h-vert">
														<div class="p-16-16">стиль</div>
														<div id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6924-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>открытые</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe693d-be61d3ef" class="m-h-vert">
														<div class="p-16-16">ткань</div>
														<div id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6940-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>Фатин</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6953-be61d3ef" class="m-h-vert">
														<div class="p-16-16">топ бренды</div>
														<div id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6956-be61d3ef" class="m-h-vert grider">
															<a href="#" class="a-12-12 w-inline-block">
																<div>AVE</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
															...
															<a id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe696f-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>Kookla</div>
															</a>
															<a id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6972-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>S. markelova</div>
															</a>
															<a id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6975-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>milva</div>
															</a>
															<a id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6978-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>Divino Rose</div>
															</a>
															<a id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe697b-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>S. markelova</div>
															</a>
														</div>
													</div>
													<div id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe697e-be61d3ef" class="m-h-vert">
														<div class="p-16-16">стоимость</div>
														<div id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6981-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>10 000 ₽ - 20 000 ₽</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_24430ecd-3c0a-8a34-3441-3367c0fe6991-be61d3ef" class="menu-choosed-items">
														<a href="#" class="choosed-item w-inline-block">
															<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/67248e4a97ea03b0819eef08_Group20246.avif" loading="lazy" alt class="img-cover"></div>
															<div class="choosed-item_bottom">
																<div>Свадебное платье Даниэль</div>
											...
											<div class="menu-link-keeper">
												...
												<div class="hovered-menue">
													<div id="w-node-_89d3490f-1330-3947-72e7-6c26478441ca-be61d3ef" class="m-h-vert">
														...
														<div id="w-node-_89d3490f-1330-3947-72e7-6c26478441cd-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>а-силуэт</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_89d3490f-1330-3947-72e7-6c26478441e6-be61d3ef" class="m-h-vert">
														<div class="p-16-16">стиль</div>
														<div id="w-node-_89d3490f-1330-3947-72e7-6c26478441e9-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>открытые</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_89d3490f-1330-3947-72e7-6c2647844202-be61d3ef" class="m-h-vert">
														<div class="p-16-16">ткань</div>
														<div id="w-node-_89d3490f-1330-3947-72e7-6c2647844205-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>Фатин</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_89d3490f-1330-3947-72e7-6c2647844218-be61d3ef" class="m-h-vert">
														<div class="p-16-16">топ бренды</div>
														<div id="w-node-_89d3490f-1330-3947-72e7-6c264784421b-be61d3ef" class="m-h-vert grider">
															<a href="#" class="a-12-12 w-inline-block">
																<div>AVE</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
															...
															<a id="w-node-_89d3490f-1330-3947-72e7-6c2647844234-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>Kookla</div>
															</a>
															<a id="w-node-_89d3490f-1330-3947-72e7-6c2647844237-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>S. markelova</div>
															</a>
															<a id="w-node-_89d3490f-1330-3947-72e7-6c264784423a-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>milva</div>
															</a>
															<a id="w-node-_89d3490f-1330-3947-72e7-6c264784423d-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>Divino Rose</div>
															</a>
															<a id="w-node-_89d3490f-1330-3947-72e7-6c2647844240-be61d3ef" href="#" class="a-12-12 w-inline-block">
																<div>S. markelova</div>
															</a>
														</div>
													</div>
													<div id="w-node-_89d3490f-1330-3947-72e7-6c2647844243-be61d3ef" class="m-h-vert">
														<div class="p-16-16">стоимость</div>
														<div id="w-node-_89d3490f-1330-3947-72e7-6c2647844246-be61d3ef" class="m-h-vert">
															<a href="#" class="a-12-12 w-inline-block">
																<div>10 000 ₽ - 20 000 ₽</div>
															</a>
															<a href="#" class="a-12-12 w-inline-block">
													...
													<div id="w-node-_89d3490f-1330-3947-72e7-6c2647844256-be61d3ef" class="menu-choosed-items">
														<a href="#" class="choosed-item w-inline-block">
															<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/67248e4a97ea03b0819eef08_Group20246.avif" loading="lazy" alt class="img-cover"></div>
															<div class="choosed-item_bottom">
																<div>Свадебное платье Даниэль</div>
										...
										<div class="menu-line p-12-12 white uper rev n-voreder">
											<a href="/atele" class="n-menu w-nav-link">аксессуары</a><a href="/blog" class="n-menu w-nav-link">Ателье</a><a href="/otzivs" class="n-menu w-nav-link">отзывы</a>
											<div class="horiz">
												<div>8 812 425 22 75</div>
												<a href="#" class="show-all-btn">показать</a>
											</div>
						...
						<div data-delay="4000" data-animation="cross" class="slider_home-slider w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="0" data-duration="500" data-infinite="true">
							<div class="w-slider-mask">
								<div class="w-slide">
									<div class="slider_home-slider_slide-in">
										...
										<div class="slider-bottom-content">
											<div class="p-12-12">ОСОБЕННО ЯРКИЕ МОМЕНТЫ</div>
											<p class="p-86-96">свадебный салон</p>
											<p class="p-16-20">Свадебный салон LoveForever это больше чем просто свадебные платья, это целый комплекс услуг по созданию гармоничного образа невесты.</p>
											<a href="#" class="btn in-slider-btn w-inline-block">
												<div>перейти в каталог</div>
											</a>
										</div>
									</div>
								...
								<div class="w-slide">
									<div class="slider_home-slider_slide-in">
										<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/6721f8e64aae0cea4f4f1939_image206.avif" loading="eager" alt class="img-cover"></div>
										<div class="slider-bottom-content">
											<div class="p-12-12">ОСОБЕННО ЯРКИЕ МОМЕНТЫ</div>
											<p class="p-86-96">свадебный салон</p>
											<p class="p-16-20">Свадебный салон LoveForever это больше чем просто свадебные платья, это целый комплекс услуг по созданию гармоничного образа невесты.</p>
				...
				<section class="section">
					<div class="container n-top m-scrll">
						<div class="fast-links">
							<a href="#" class="btn fast-link-btn w-inline-block">
								<div class="fast-link-omg-mom"><img src="<?php echo get_template_directory_uri(); ?>/images/6720cf266f1f5059b3ae029d_Group20192.avif" loading="lazy" alt class="img-60w"></div>
								<div>сияй</div>
							</a>
							<a href="#" class="btn fast-link-btn w-inline-block">
								<div class="fast-link-omg-mom"><img src="<?php echo get_template_directory_uri(); ?>/images/6720cf266f1f5059b3ae029d_Group20192.avif" loading="lazy" alt class="img-60w"></div>
				...
				<section class="section">
					<div class="container n-top">
						<div class="akcc-line">
							<div class="timer-mom">
								<div class="p-48-48">01</div>
								<div class="p-12-12 p-r-40">дни</div>
								<div class="p-48-48">13</div>
								<div class="p-12-12 p-r-40">часы</div>
								<div class="p-48-48">53</div>
								<div class="p-12-12 p-r-40">минуты</div>
							</div>
							<div class="p-20-26 mmax295">с 19 сентября по 1 октября -50% на свадебные платья от бренда Даниэль</div>
							<a href="#" class="btn in-slider-btn purple-color p-l-48 w-inline-block">
								<div>подробнее</div>
							</a>
						</div>
					</div>
				...
				<section class="section">
					<div class="container">
						<div class="spleet">
							<h2 class="h-36-36">популярное</h2>
							<a id="w-node-db76596e-4fc1-70c6-bdf8-c5a48b11e020-7ea1ac8d" href="#" class="btn btn-with-arrow w-inline-block">
								<div>Смотреть все</div>
						...
						<div class="splide no-pc">
							<div class="splide__track">
								<div class="splide__list search-grid">
									...
									<div id="w-node-d7a36ef2-0b05-702c-4d38-4d2b364a226d-7ea1ac8d" class="splide__slide">
										<div id="w-node-_8b2437f6-1b94-79d9-89d9-2e5214ebae27-7ea1ac8d" class="prod-item">
											<div class="prod-item_top">
												<div data-delay="4000" data-animation="slide" class="slider w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
													<div class="w-slider-mask">
														<div class="w-slide">
															<a href="#" class="link w-inline-block">
																<div class="prod-item_img-mom">
																	<div class="mom-abs"><img alt src="<?php echo get_template_directory_uri(); ?>/images/672b72c58a6f484dee2244e1_Group20578.jpg" loading="lazy" class="img-cover"></div>
																</div>
															</a>
														</div>
														<div class="w-slide">
															<a href="#" class="link w-inline-block">
																<div class="prod-item_img-mom">
																	<div class="mom-abs"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/images/6721e83f61d503dbabc19bcc_Group20184.avif" alt class="img-cover"></div>
																</div>
															</a>
														</div>
													</div>
											...
											<a href="#" class="prod-item_bottom w-inline-block">
												<div class="p-12-12 uper">Свадебное платье Даниэль</div>
												<div class="horiz indirim-horiz">
													<div class="p-12-12 italic letter-5">29 500 ₽</div>
													<div class="p-12-12 italic letter-5 oldprice">29 500 ₽</div>
												</div>
									...
									<div id="w-node-b118d9ea-ffcc-fbf7-79d2-6af824fec453-7ea1ac8d" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
									...
									<div id="w-node-_76882270-7c90-2fc8-8c71-a34d200b5af4-7ea1ac8d" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
				...
				<section class="section">
					<div class="container">
						<div class="bigcards-grid">
							<div id="w-node-e4234285-7aeb-3f92-ffde-315fc2aa29dc-7ea1ac8d" class="bigcard-item _2cols">
								<div class="slider_home-slider_slide-in">
									<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/6720cba51d20b92a6113dd64_90072882eeba72644a041d3491499eda-min.avif" loading="eager" alt class="img-cover"></div>
									<div class="slider-bottom-content _w-auto">
										<div class="p-12-12 uper">5491 свадебных платьев</div>
										<p class="p-86-96 t-64-64">свадебные платья</p>
										<div class="horiz center-horiz">
											<a href="#" class="a-12-12">короткие</a>
											<div class="_2px_romb"></div>
											<a href="#" class="a-12-12">длинные</a>
											<div class="_2px_romb"></div>
											<a href="#" class="a-12-12">рыбка</a>
											<div class="_2px_romb"></div>
											<a href="#" class="a-12-12">пышные</a>
											<div class="_2px_romb"></div>
											<a href="#" class="a-12-12">короткие</a>
										</div>
										<a href="#" class="btn in-slider-btn w-inline-block">
							...
							<div id="w-node-cd7e1829-1ada-5809-2a7b-c6853ce2af05-7ea1ac8d" class="bigcard-item">
								<div class="slider_home-slider_slide-in">
									<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/6721f8e64aae0cea4f4f1939_image206.avif" loading="eager" alt class="img-cover"></div>
									<div class="slider-bottom-content _w-auto">
										<div class="p-12-12 uper">1273 вечерних платьев</div>
										<p class="p-64-64">вечерние платья</p>
										<div class="horiz center-horiz">
											<a href="#" class="a-12-12">короткие</a>
											<div class="_2px_romb"></div>
											<a href="#" class="a-12-12">длинные</a>
							...
							<div id="w-node-_33750394-2a67-a842-08f3-f11e4775ede9-7ea1ac8d" class="bigcard-item">
								<div class="slider_home-slider_slide-in">
									<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/6721f8f87c8f96e04a66692a_D184D0BED182D0BE.avif" loading="eager" alt class="img-cover"></div>
									<div class="slider-bottom-content _w-auto">
										<div class="p-12-12 uper">1273 вечерних платьев</div>
										<p class="p-64-64">выпускные платья</p>
										<div class="horiz center-horiz">
											<a href="#" class="a-12-12">короткие</a>
											<div class="_2px_romb"></div>
											<a href="#" class="a-12-12">длинные</a>
				...
				<section class="section">
					<div class="container">
						<div class="spleet">
							<h2 class="h-36-36">новинки</h2>
							<a id="w-node-_980e4616-8149-20a0-9a7a-86a3073ce8a2-7ea1ac8d" href="#" class="btn btn-with-arrow w-inline-block">
								<div>Смотреть все</div>
								<img src="<?php echo get_template_directory_uri(); ?>/images/6720d17cfb5622b535a21354_Arrow20Down.svg" loading="eager" alt class="img-arrow">
							</a>
						</div>
						<div class="splide no-pc">
							<div class="splide__track">
								<div class="splide__list search-grid">
									<div id="w-node-_46c36a84-3305-1ecd-c3ab-d10c6e0213ef-7ea1ac8d" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
									...
									<div id="w-node-_46c36a84-3305-1ecd-c3ab-d10c6e0213f1-7ea1ac8d" class="splide__slide">
										<div id="w-node-_46c36a84-3305-1ecd-c3ab-d10c6e0213f2-7ea1ac8d" class="prod-item">
											<div class="prod-item_top">
												<div data-delay="4000" data-animation="slide" class="slider w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
													<div class="w-slider-mask">
														<div class="w-slide">
									...
									<div id="w-node-_46c36a84-3305-1ecd-c3ab-d10c6e021412-7ea1ac8d" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
									...
									<div id="w-node-_46c36a84-3305-1ecd-c3ab-d10c6e021414-7ea1ac8d" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
				...
				<section class="section">
					<div class="container">
						<div class="bigcards-grid">
							<div id="w-node-_656e5bb7-8bed-6689-b6bb-b55592bf4f55-7ea1ac8d" class="bigcard-item _2cols">
								<div class="slider_home-slider_slide-in">
									<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/6721f94cc864603209a8e072_santedesign_httpss_mj_runhp57pyTEyYs_httpss_mj_runUSyr5XjlbgQ_A.avif" loading="eager" alt class="img-cover"></div>
									<div class="slider-bottom-content _w-auto">
										<div class="p-12-12 uper">5491 свадебных платьев</div>
										<p class="p-86-96">аксессуары</p>
										<div class="horiz center-horiz">
											<a href="#" class="a-12-12">короткие</a>
											<div class="_2px_romb"></div>
											<a href="#" class="a-12-12">длинные</a>
							...
							<div id="w-node-_656e5bb7-8bed-6689-b6bb-b55592bf4f70-7ea1ac8d" class="bigcard-item">
								<div class="slider_home-slider_slide-in">
									<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/6721f8e64aae0cea4f4f1939_image206.avif" loading="eager" alt class="img-cover"></div>
									<div class="slider-bottom-content _w-auto">
										<div class="p-12-12 uper">1273 вечерних платьев</div>
										<p class="p-64-64">распродажа</p>
										<div class="horiz center-horiz">
											<a href="#" class="a-12-12">короткие</a>
											<div class="_2px_romb"></div>
											<a href="#" class="a-12-12">длинные</a>
							...
							<div id="w-node-_656e5bb7-8bed-6689-b6bb-b55592bf4f8b-7ea1ac8d" class="bigcard-item">
								<div class="slider_home-slider_slide-in">
									<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/6721f8f87c8f96e04a66692a_D184D0BED182D0BE.avif" loading="eager" alt class="img-cover"></div>
									<div class="slider-bottom-content _w-auto">
										<div class="p-12-12 uper">1273 вечерних платьев</div>
										<p class="p-64-64">ателье</p>
										<div class="horiz center-horiz">
											<a href="#" class="a-12-12">короткие</a>
											<div class="_2px_romb"></div>
											<a href="#" class="a-12-12">длинные</a>
						...
						<div class="splide no-pc">
							<div class="splide__track">
								<div class="splide__list search-grid">
									...
									<div id="w-node-b3928613-0859-fa0e-0b82-3fb78df5fb78-7ea1ac8d" class="splide__slide">
										<div id="w-node-b3928613-0859-fa0e-0b82-3fb78df5fb79-7ea1ac8d" class="prod-item">
											<div class="prod-item_top">
												<div data-delay="4000" data-animation="slide" class="slider w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
													<div class="w-slider-mask">
														<div class="w-slide">
									...
									<div id="w-node-b3928613-0859-fa0e-0b82-3fb78df5fb99-7ea1ac8d" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
									...
									<div id="w-node-b3928613-0859-fa0e-0b82-3fb78df5fb9b-7ea1ac8d" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
						...
						<div class="splide no-pc">
							<div class="splide__track">
								<div class="splide__list search-grid">
									...
									<div id="w-node-_060f033b-d108-876e-d4aa-9a2eeb269f3a-7ea1ac8d" class="splide__slide">
										<div id="w-node-_060f033b-d108-876e-d4aa-9a2eeb269f3b-7ea1ac8d" class="prod-item">
											<div class="prod-item_top">
												<div data-delay="4000" data-animation="slide" class="slider w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
													<div class="w-slider-mask">
														<div class="w-slide">
									...
									<div id="w-node-_060f033b-d108-876e-d4aa-9a2eeb269f5b-7ea1ac8d" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
									...
									<div id="w-node-_060f033b-d108-876e-d4aa-9a2eeb269f5d-7ea1ac8d" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top">
												<a href="#" class="link w-inline-block">
													<div class="prod-item_img-mom">
				...
				<section class="section">
					<div class="container">
						<div class="spleet">
							...
							<a id="w-node-_42e31bf8-b85c-a9ca-923c-af59232d595e-7ea1ac8d" href="#" class="btn btn-with-arrow w-inline-block">
								<div>Смотреть все</div>
								<img src="<?php echo get_template_directory_uri(); ?>/images/6720d17cfb5622b535a21354_Arrow20Down.svg" loading="eager" alt class="img-arrow">
							</a>
						</div>
								...
								<div class="splide__list otzivi-grid">
									<div id="w-node-_3d0d88a6-0e54-32cf-18c5-8b1680228c84-7ea1ac8d" class="splide__slide">
										<div class="oyziv-item">
											<img src="<?php echo get_template_directory_uri(); ?>/images/6721f9fb9790abdc56ba8ee1_Group20365.avif" loading="lazy" alt class="img-fw">
											<div class="vert">
									...
									<div id="w-node-_6313cebc-9e3b-7c07-d433-4eb8e6247881-7ea1ac8d" class="splide__slide">
									...
									<div id="w-node-_5ae988fa-fd27-4e00-a00f-96473e6eef67-7ea1ac8d" class="splide__slide">
										<div class="oyziv-item">
							...
							<div class="splide__track">
								<div class="splide__list search-grid">
									<div id="w-node-_2b680d64-d882-00a4-ac7a-e5a08c854948-7ea1ac8d" class="splide__slide">
										<div id="w-node-_677f8467-f63b-dc76-360c-37664d3436fc-7ea1ac8d" class="blog-item">
											<a href="#" class="blog-link w-inline-block">
												<div class="blog-link_abs-mom">
													<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/6720cba51d20b92a6113dd64_90072882eeba72644a041d3491499eda-min.avif" loading="lazy" alt class="img-cover"></div>
												</div>
												<div class="p-21-26 w500">Летнее пространство MYST — новая классная локация для твоей свадьбы</div>
												<div class="p-16-20 m-14-18">Подходящее место для свадебного торжества зачастую найти трудно.</div>
												<div class="blog-horiz">
													<div class="p-12-12 uper">16.08.24</div>
													<div class="_2px_romb purp"></div>
													<div class="p-12-12 uper">#свадебное торжество</div>
													<div class="_2px_romb purp"></div>
													<div class="p-12-12 uper">#myst</div>
												</div>
											</a>
										</div>
									</div>
									<div id="w-node-ade8b7fa-c2ca-02dc-b4cc-d719e61fc5ac-7ea1ac8d" class="splide__slide">
										<div id="w-node-ade8b7fa-c2ca-02dc-b4cc-d719e61fc5ad-7ea1ac8d" class="blog-item">
											<a href="#" class="blog-link w-inline-block">
												<div class="blog-link_abs-mom">
													<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/6720cba51d20b92a6113dd64_90072882eeba72644a041d3491499eda-min.avif" loading="lazy" alt class="img-cover"></div>
												</div>
									...
									<div id="w-node-d91301db-3a4b-186f-569a-aa3a954d405c-7ea1ac8d" class="splide__slide">
										<div id="w-node-d91301db-3a4b-186f-569a-aa3a954d405d-7ea1ac8d" class="blog-item">
											<a href="#" class="blog-link w-inline-block">
												<div class="blog-link_abs-mom">
													<div class="mom-abs"><img src="<?php echo get_template_directory_uri(); ?>/images/6720cba51d20b92a6113dd64_90072882eeba72644a041d3491499eda-min.avif" loading="lazy" alt class="img-cover"></div>
												</div>
				...
				<section class="section">
					<div class="container">
						<h2 class="h-64-64 uper _w-ligi">Выбирать свадебное <br>платье — это очень личное.</h2>
					...
					<div class="container">
						<div class="vert vert-center m-str">
							<div class="map-keeper">
								<img src="<?php echo get_template_directory_uri(); ?>/images/6722012d311dbf40315210e6_Group2079.svg" loading="lazy" alt class="img-map">
								<div class="map-dot">
							...
							<a href="#" class="btn pink-btn w-inline-block">
					...
					<div class="container foo-container">
						<div class="foo-top">
							...
							<div id="w-node-_68f6fa66-2e99-69ec-af7c-da5704d78a88-b053f56f" class="vert">
								...
								<div class="vert-foo">
									...
									<a href="#" class="a-12-12 w-inline-block">
										<div>примерочная (<span class="prim-count">2</span>)</div>
									</a>
								</div>
							</div>
							<div id="w-node-e462508c-6438-de3d-e96e-4e0519948197-b053f56f" class="vert">
								...
								<div class="vert-foo">
									<a href="#" class="a-12-12 w-inline-block">
										<div>8 (812) 425-69-36</div>
									</a>
									<a href="#" class="a-12-12 w-inline-block">
										<div>SPB@SALON-LOVE.RU</div>
									</a>
									<a href="#" class="a-12-12 w-inline-block">
						...
						<div class="foo-top bott">
							...
							<div id="w-node-b25aa748-36cb-7692-2710-65768ffd5ebd-b053f56f" class="vert m-none">
								<a href="#" class="a-12-12 to-top w-inline-block">
		...
		<div class="ui">
			...
			<a href="#" class="btn in-slider-btn purple-color w-inline-block">
				<div>подробнее</div>
			</a>
			<a href="#" class="w-inline-block"></a>
			<a id="w-node-_6d0e6280-7f82-d571-8601-b6d6f3ab2482-f3ab2472" href="#" class="btn btn-with-arrow w-inline-block">
				<div>Смотреть все</div>
				<img src="<?php echo get_template_directory_uri(); ?>/images/6720d17cfb5622b535a21354_Arrow20Down.svg" loading="eager" alt class="img-arrow">
			</a>
			<a id="w-node-_4666dd82-d674-9aae-955c-43b4bc3b8fc9-f3ab2472" href="#" class="btn grey-border_btn w-inline-block">
				<div class="p-12-12">атлас</div>
			</a>
