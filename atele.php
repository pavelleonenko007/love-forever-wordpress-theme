...
?>
    <!DOCTYPE html>
<html data-wf-page="672b7226388c19d05966575b" data-wf-site="6720c60d7d5faf3e7ea1ac86">
...
<input type="submit" class="search-button w-button" value="Search"><a href="#" class="clear-search">очистить</a></form>
									...
									<div class="spleet m-none">
										...
										<div class="l-spacer"></div>
										<div class="menu-line p-12-12 white uper rev n-voreder"><a href="/atele" aria-current="page" class="n-menu w-nav-link w--current">Ателье</a><a href="/blog" class="n-menu w-nav-link">блог</a><a href="/faq" class="n-menu w-nav-link">вопрос-ответ</a><a href="/otzivs" class="n-menu w-nav-link">отзывы</a><a href="/contacts" class="n-menu w-nav-link">контакты</a>
							...
							<div class="fixed-navbar menuline">
								<div class="vert-menu">
									<div class="spleet m-none">
										...
										<div class="menu-line p-12-12 white uper rev n-voreder"><a href="/atele" aria-current="page" class="n-menu w-nav-link w--current">аксессуары</a><a href="/blog" class="n-menu w-nav-link">Ателье</a><a href="/otzivs" class="n-menu w-nav-link">отзывы</a>
											<div class="horiz">
												<div>8 812 425 22 75</div><a href="#" class="show-all-btn">показать</a></div>
...
<input type="submit" class="search-button w-button" value="Search"><a href="#" class="clear-search">очистить</a></form>
						...
						<div class="slider_home-slider_slide-in">
							<div class="mom-abs"><img src="<?php echo get_template_directory_uri() ?>/images/672b72f61def5438d7190bfa_image2025(1)201.jpg" loading="eager" alt class="img-cover"></div>
							<div class="slider-bottom-content">
								<div class="horiz">
									<div class="p-12-12 uper">опытные портные</div>
								</div>
								<h1 class="p-86-96">ателье</h1>
								<p class="p-16-20 mmax695">Выбирали в команду портных с профильным образованием и опытом работы на  свадебном производстве, поэтому им можно доверить даже самую сложную  задачу.</p><a href="#" class="btn in-slider-btn w-inline-block"><div>записаться</div></a></div>
						</div>
					</div>
				</section>
				<section class="section">
					<div class="container">
						<div class="flex-about"><img src="<?php echo get_template_directory_uri() ?>/images/672b72c58a6f484dee2244e1_Group20578.jpg" loading="lazy" alt class="image">
							<div class="div-block-3">
								<div id="w-node-_7a1f9b32-ca32-356a-7188-ae3258fc571a-5966575b" class="div-block-4"><img src="<?php echo get_template_directory_uri() ?>/images/672b6da9d7c0f40bf00e5ac8_Group20442.svg" loading="lazy" alt class="image-2">
								...
								<div id="w-node-_9a9729a2-c4f5-fd4e-178e-2f49feb5acb1-5966575b" class="div-block-4"><img src="<?php echo get_template_directory_uri() ?>/images/672b6e5326479af83bdbf512_Group20441.svg" loading="lazy" alt class="image-2">
									<div class="p-36-36 about-p"><span class="span-pink">лучшие </span><br>из лучших</div>
									<p class="p-16-20 abput-p-small">Платья мировых брендов: ажурные и скромные, пышные как у диснеевских принцесс или изящные русалочки</p>
								</div>
								<div id="w-node-c793a6d2-afd6-6b97-35c5-417a362f9304-5966575b" class="div-block-4"><img src="<?php echo get_template_directory_uri() ?>/images/672b6e531b7f5130a35615c3_Group20440.svg" loading="lazy" alt class="image-2">
									<div class="p-36-36 about-p"><span class="span-pink">лучшие </span><br>из лучших</div>
									<p class="p-16-20 abput-p-small">Платья мировых брендов: ажурные и скромные, пышные как у диснеевских принцесс или изящные русалочки</p>
								</div>
								<div id="w-node-a760134a-47d7-5169-31c1-06aa576c147a-5966575b" class="div-block-4"><img src="<?php echo get_template_directory_uri() ?>/images/672b6e5313324b8f4f1418b6_Group20443.svg" loading="lazy" alt class="image-2">
									<div class="p-36-36 about-p"><span class="span-pink">лучшие </span><br>из лучших</div>
									<p class="p-16-20 abput-p-small">Платья мировых брендов: ажурные и скромные, пышные как у диснеевских принцесс или изящные русалочки</p>
								</div>
							</div>
				...
				<section class="section">
					<div class="container">
						<h2 class="p-64-64 center">Твое платье, <br>твоя <span class="span-pink">история любви</span></h2>
