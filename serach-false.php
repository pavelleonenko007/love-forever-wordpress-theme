<?php
/*
Template name: Serach false
*/
?>
    <!DOCTYPE html>
<html data-wf-page="672b5cad8a7e5a84a36d4c52" data-wf-site="6720c60d7d5faf3e7ea1ac86">
...
<input type="submit" class="search-button w-button" value="Search"><a href="#" class="clear-search">очистить</a></form>
						...
						<div class="page-top">
							<div class="horiz">
								<div class="p-12-12 uper">ничего не найдено по вашему запросу</div>
							</div>
							<h1 class="p-86-96">орапрут</h1>
							<div class="p-16-20 mmmaw197">Попробуйте снова, либо ознакомтесь с ассортиментом в каталоге</div>
							<div class="cats-horiz center p-l-10"><a href="#" class="btn grey-border_btn in-single w-inline-block"><div>свадебный каталог</div></a><a href="#" class="btn grey-border_btn in-single w-inline-block"><div>вечерний каталог</div></a><a href="#" class="btn grey-border_btn in-single w-inline-block"><div>выпускной каталог</div></a></div>
						</div>
					</div>
				</section>
				<section class="section">
					<div class="container p-t-60 m-t-10">
						<div class="spleet">
							<h2 class="h-36-36">возможно вы искали</h2>
						...
						<div class="splide y-pc">
							<div class="splide__track">
								<div class="splide__list search-grid">
									<div id="w-node-c9da0743-7ba6-5a61-a9e2-5c56362dad77-a36d4c52" class="splide__slide">
									...
									<div id="w-node-c9da0743-7ba6-5a61-a9e2-5c56362dad79-a36d4c52" class="splide__slide">
										<div id="w-node-c9da0743-7ba6-5a61-a9e2-5c56362dad7a-a36d4c52" class="prod-item">
									...
									<div id="w-node-c9da0743-7ba6-5a61-a9e2-5c56362dad9a-a36d4c52" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top"><a href="#" class="link w-inline-block"><div class="prod-item_img-mom"><div class="mom-abs"><img src="<?php echo get_template_directory_uri() ?>/images/6721e83f61d503dbabc19bcc_Group20184.avif" loading="lazy" alt class="img-cover"></div></div></a><a href="#" class="btn-like w-inline-block"><div class="svg w-embed"><svg width="30" height="35" viewbox="0 0 30 35" fill="none" xmlns="http://www.w3.org/2000/svg"><rect y="5" width="30" height="30" fill="#F22EA9"></rect><path d="M30 5L25 0V5H30Z" fill="#F22EA9"></path><path d="M30 5L25 0V5H30Z" fill="black" fill-opacity="0.2"></path><path d="M20.4894 20.8851L20.4917 20.8874L15.0022 26.298L8.63543 20.0226C7.12152 18.5304 7.12152 16.1143 8.63543 14.6221C10.1534 13.126 12.6173 13.126 14.1353 14.6221L14.649 15.1285L15 15.4744L15.351 15.1285L15.8647 14.6221C17.3827 13.126 19.8466 13.126 21.3646 14.6221C22.8785 16.1143 22.8785 18.5304 21.3646 20.0226L20.8508 20.529L20.4894 20.8851Z" stroke="white"></path></svg></div></a>
												<div class="img-indirim"><img src="<?php echo get_template_directory_uri() ?>/images/6722209ada917fe93f9a511b_Group20185.svg" loading="lazy" alt class="img-fh"><img src="<?php echo get_template_directory_uri() ?>/images/6722210212c04f42b1086a3c_Rectangle2021.svg" loading="lazy" alt class="img-tr"></div>
											</div><a href="#" class="prod-item_bottom w-inline-block"><div class="p-12-12 uper m-12-12">Свадебное платье Даниэль</div><div class="horiz indirim-horiz"><div class="p-12-12 italic letter-5">29 500 ₽</div><div class="p-12-12 italic letter-5 oldprice">29 500 ₽</div></div></a></div>
									</div>
									<div id="w-node-c9da0743-7ba6-5a61-a9e2-5c56362dad9c-a36d4c52" class="splide__slide">
										<div id="w-node-_6e88719d-fe8f-116f-4337-b580b5a0b461-b5a0b461" class="prod-item">
											<div class="prod-item_top"><a href="#" class="link w-inline-block"><div class="prod-item_img-mom"><div class="mom-abs"><img src="<?php echo get_template_directory_uri() ?>/images/6721e83f61d503dbabc19bcc_Group20184.avif" loading="lazy" alt class="img-cover"></div></div></a><a href="#" class="btn-like w-inline-block"><div class="svg w-embed"><svg width="30" height="35" viewbox="0 0 30 35" fill="none" xmlns="http://www.w3.org/2000/svg"><rect y="5" width="30" height="30" fill="#F22EA9"></rect><path d="M30 5L25 0V5H30Z" fill="#F22EA9"></path><path d="M30 5L25 0V5H30Z" fill="black" fill-opacity="0.2"></path><path d="M20.4894 20.8851L20.4917 20.8874L15.0022 26.298L8.63543 20.0226C7.12152 18.5304 7.12152 16.1143 8.63543 14.6221C10.1534 13.126 12.6173 13.126 14.1353 14.6221L14.649 15.1285L15 15.4744L15.351 15.1285L15.8647 14.6221C17.3827 13.126 19.8466 13.126 21.3646 14.6221C22.8785 16.1143 22.8785 18.5304 21.3646 20.0226L20.8508 20.529L20.4894 20.8851Z" stroke="white"></path></svg></div></a>
												<div class="img-indirim"><img src="<?php echo get_template_directory_uri() ?>/images/6722209ada917fe93f9a511b_Group20185.svg" loading="lazy" alt class="img-fh"><img src="<?php echo get_template_directory_uri() ?>/images/6722210212c04f42b1086a3c_Rectangle2021.svg" loading="lazy" alt class="img-tr"></div>
											</div><a href="#" class="prod-item_bottom w-inline-block"><div class="p-12-12 uper m-12-12">Свадебное платье Даниэль</div><div class="horiz indirim-horiz"><div class="p-12-12 italic letter-5">29 500 ₽</div><div class="p-12-12 italic letter-5 oldprice">29 500 ₽</div></div></a></div>
