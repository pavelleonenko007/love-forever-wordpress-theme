...
?>
<article class="test-grid lf-promo-block lf-promo-block-9">
	<div class="lf-promo-block__wrapper lf-promo-block-9__wrapper">
		<a <?php echo $link_attributes; ?> class="lf-promo-block-9__link">
			<div class="lf-promo-block-9__image">
				<?php echo wp_get_attachment_image( $template_fields['custom_img'], 'fullhd' ); ?>
			</div>
			<div class="lf-promo-block-9__content">
				<h3 class="lf-promo-block-9__title">
					<span class="lf-promo-block-9__span lf-promo-block-9__span--1"><?php echo $field1; ?></span>
					<span class="lf-promo-block-9__span lf-promo-block-9__span--2"><?php echo $field2; ?></span>
				</h3>
			</div>
		</a>
	</div>
